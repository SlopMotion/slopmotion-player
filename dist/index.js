...
uv.x /= aspect;
return uv;`,H4=`float luma = dot(_c0.rgb, vec3(0.299, 0.587, 0.114));
return vec4(mix(_c0.rgb, vec3(luma), a * 0.7), _c0.a);`;function ch(e){return Math.round(e)===1?H4:ps}function uh(e,t){let n=Math.round(t)===1?"color":"coord",o=e.trim().replace(/^#version[^\n]*\n?/gm,"");return/\breturn\b/.test(o)||(o=n==="coord"?`${o}
return _st;`:`${o}
...
Try Firefox 29 or later, or Chrome 47 or later, with Enable experimental Web Platform features enabled from chrome://flags.`),console.error("Exception while creating MediaRecorder:",r);return}}}console.log("Created MediaRecorder",this.mediaRecorder,"with options",t),this.mediaRecorder.onstop=this._handleStop.bind(this),this.mediaRecorder.ondataavailable=this._handleDataAvailable.bind(this),this.mediaRecorder.start(100),console.log("MediaRecorder started",this.mediaRecorder)}stop(){this.mediaRecorder.stop()}_handleStop(){let t=new Blob(this.recordedBlobs,{type:this.mediaRecorder.mimeType}),n=window.URL.createObjectURL(t);this.output.src=n;let o=document.createElement("a");o.style.display="none",o.href=n;let r=new Date;o.download=`hydra-${r.getFullYear()}-${r.getMonth()+1}-${r.getDate()}-${r.getHours()}.${r.getMinutes()}.${r.getSeconds()}.webm`,document.body.appendChild(o),o.click(),setTimeout(()=>{document.body.removeChild(o),window.URL.revokeObjectURL(n)},300)}_handleDataAvailable(t){t.data&&t.data.size>0&&this.recordedBlobs.push(t.data)}},c_=Ep;u();u();var Ul={linear:function(e){return e},easeInQuad:function(e){return e*e},easeOutQuad:function(e){return e*(2-e)},easeInOutQuad:function(e){return e<.5?2*e*e:-1+(4-2*e)*e},easeInCubic:function(e){return e*e*e},easeOutCubic:function(e){return--e*e*e+1},easeInOutCubic:function(e){return e<.5?4*e*e*e:(e-1)*(2*e-2)*(2*e-2)+1},easeInQuart:function(e){return e*e*e*e},easeOutQuart:function(e){return 1- --e*e*e*e},easeInOutQuart:function(e){return e<.5?8*e*e*e*e:1-8*--e*e*e*e},easeInQuint:function(e){return e*e*e*e*e},easeOutQuint:function(e){return 1+--e*e*e*e*e},easeInOutQuint:function(e){return e<.5?16*e*e*e*e*e:1+16*--e*e*e*e*e},sin:function(e){return(1+Math.sin(Math.PI*e-Math.PI/2))/2}};var h5=(e,t,n,o,r)=>(e-t)*(r-o)/(n-t)+o,Pp=(e,t)=>(e%t+t)%t,Vl={init:()=>{Array.prototype.fast=function(e=1){return this._speed=e,this},Array.prototype.smooth=function(e=1){return this._smooth=e,this},Array.prototype.ease=function(e="linear"){return typeof e=="function"?(this._smooth=1,this._ease=e):Ul[e]&&(this._smooth=1,this._ease=Ul[e]),this},Array.prototype.offset=function(e=.5){return this._offset=e%1,this},Array.prototype.fit=function(e=0,t=1){let n=Math.min(...this),o=Math.max(...this);var r=this.map(i=>h5(i,n,o,e,t));return r._speed=this._speed,r._smooth=this._smooth,r._ease=this._ease,r}},getValue:(e=[])=>({time:t,bpm:n})=>{let o=e._speed?e._speed:1,r=e._smooth?e._smooth:0,i=t*o*(n/60)+(e._offset||0);if(r!==0){let s=e._ease?e._ease:Ul.linear,l=i-r/2,m=e[Math.floor(Pp(l,e.length))],d=e[Math.floor(Pp(l+1,e.length))],y=Math.min(Pp(l,1)/r,1);return s(y)*(d-m)+m}else{let s=e[Math.floor(i%e.length)];return e[Math.floor(i%e.length)]}}};u();u();var u_=e=>{var t="",n=r(t),o=(i,s)=>{t+=`
    ...
    `,n=r(t)};return{addToContext:o,eval:i=>n.eval(i)};function r(i){globalThis.eval(i);var s=function(l){globalThis.eval(l)};return{eval:s}}};var Fp=class{constructor(t,n,o=[]){this.makeGlobal=n,this.sandbox=u_(t),this.parent=t;var r=Object.keys(t);r.forEach(i=>this.add(i)),this.userProps=o}add(t){this.makeGlobal&&(window[t]=this.parent[t])}set(t,n){this.makeGlobal&&(window[t]=n),this.parent[t]=n}tick(){this.makeGlobal&&this.userProps.forEach(t=>{this.parent[t]=window[t]})}eval(t){this.sandbox.eval(t)}},p_=Fp;u();u();u();u();var _5={float:{vec4:{name:"sum",args:[[1,1,1,1]]},vec2:{name:"sum",args:[[1,1]]}}};var Op=e=>(e=e.toString(),e.indexOf(".")<0&&(e+="."),e);function Hp(e,t,n){let o=e.transform.inputs,r=e.userArgs,{generators:i}=e.synth,{src:s}=i;return o.map((l,m)=>{let d={value:l.default,type:l.type,isUniform:!1,name:l.name,vecLen:0};if(d.type==="float"&&(d.value=Op(l.default)),l.type.startsWith("vec"))try{d.vecLen=Number.parseInt(l.type.substr(3))}catch{console.log(`Error determining length of vector input type ${l.type} (${l.name})`)}if(r.length>m){if(d.value=r[m],d.type==="vec4"&&!(d.value.type==="GlslSource"||d.value.getTexture))throw new Error("Arguments must be a texture or GlslSource");typeof r[m]=="function"?(d.value=(B,O,K)=>{try{let X=r[m](O);return typeof X=="number"?X:(console.warn("function does not return a number",r[m]),l.default)}catch(X){return console.warn("ERROR",X),l.default}},d.isUniform=!0):r[m].constructor===Array&&(d.value=(B,O,K)=>Vl.getValue(r[m])(O),d.isUniform=!0)}if(!(t<0)){if(d.value&&d.value.transforms){let B=d.value.transforms[d.value.transforms.length-1];if(B.transform.glsl_return_type!==l.type){let O=_5[l.type];if(typeof O<"u"){let K=O[B.transform.glsl_return_type];if(typeof K<"u"){let{name:X,args:pe}=K;d.value=d.value[X](...pe)}}}d.isUniform=!1}else if(d.type==="float"&&typeof d.value=="number")d.value=Op(d.value);else if(d.type.startsWith("vec")&&typeof d.value=="object"&&Array.isArray(d.value))d.isUniform=!1,d.value=`${d.type}(${d.value.map(Op).join(", ")})`;else if(l.type==="sampler2D"){var y=d.value;d.value=()=>y.getTexture(),d.isUniform=!0}else if(d.value.getTexture&&l.type==="vec4"){var D=d.value;d.value=s(D),d.isUniform=!1}d.isUniform&&(d.name+=t)}return d})}function m_(e){var t={uniforms:[],glslFunctions:[],fragColor:""},n=d_(e,t)("c","st");t.fragColor=n;let o={};return t.uniforms.forEach(r=>o[r.name]=r),t.uniforms=Object.values(o),t}function Ip(e,t){return`${e}_i${t}`}function d_(e,t){var n=(o,r)=>"";return e.forEach((o,r)=>{let i=Hp(o,t.uniforms.length);i.forEach(l=>{l.isUniform&&t.uniforms.push(l)}),g5(o,t.glslFunctions)||t.glslFunctions.push(o);var s=n;o.transform.type==="src"?n=(l,m)=>`${bs(i,t)(`${l}${r}`,m)}
         ...
         ${d_(r.value.transforms,t)(m,d)}`})}),n}function ys(e,t,n,o){let r=o.map((i,s)=>i.isUniform?i.name:i.value&&i.value.transforms?Ip(e,s):i.value).reduce((i,s)=>`${i}, ${s}`,"");return`${n}(${t}${r})`}function g5(e,t){for(var n=0;n<t.length;n++)if(e.name==t[n].name)return!0;return!1}u();var f_={_luminance:{type:"util",glsl:`float _luminance(vec3 rgb){
...
`;var Gs=6,Jb=Xm;function Rc(){return[]}function ey(e,t){e.push({bornMs:t});let n=Gs*4;for(;e.length>n;)e.shift()}function ty(e,t){let n=[];for(let o=e.length-1;o>=0;o--){let r=e[o],i=(t-r.bornMs)/1e3;if(i>=Jb){e.splice(o,1);continue}n.push({ageFrac:Math.max(0,Math.min(1,i/Jb))})}return n.length>Gs&&(n.sort((o,r)=>o.ageFrac-r.ageFrac),n.length=Gs),{count:n.length,slots:n}}var Ac=Gs,Ei=null;function ny(e){if(Ei)return;let t=new Uint8Array(Ac*4),n=e.texture({data:t,shape:[Ac,1],wrap:"clamp",mag:"nearest",min:"nearest"});Ei={data:t,tex:n}}function Ec(){return Ei?{getTexture:()=>Ei.tex}:{getTexture:()=>(console.warn("[electricNoise] trigger texture not loaded yet"),null)}}function oy(e){if(!Ei)return;let{data:t,tex:n}=Ei;t.fill(0);let o=Math.min(e.length,Ac);for(let i=0;i<o;i++){let s=Math.max(0,Math.min(1,e[i].ageFrac)),l=i*4;t[l]=Math.round(s*255),t[l+3]=255}n.subimage?.({data:t,width:Ac,height:1})}u();u();var YM=[1,2,4,8];function Ia(e){let t=YM;if(t.includes(e))return e;let n=t[0];for(let o of t)Math.abs(o-e)<Math.abs(n-e)&&(n=o);return n}var Yo=(e,t,n,o,r)=>`
  ...
  for (float layerIdx = 0.0; layerIdx < 8.0; layerIdx += 1.0) {
    ...
    ${Ur("p0","-1.0","-1.0","id","tAnim")}
    ${Ur("p1","0.0","-1.0","id","tAnim")}
    ${Ur("p2","1.0","-1.0","id","tAnim")}
    ${Ur("p3","-1.0","0.0","id","tAnim")}
    ${Ur("p4","0.0","0.0","id","tAnim")}
    ${Ur("p5","1.0","0.0","id","tAnim")}
    ${Ur("p6","-1.0","1.0","id","tAnim")}
    ${Ur("p7","0.0","1.0","id","tAnim")}
    ${Ur("p8","1.0","1.0","id","tAnim")}
    ...
    ${zs("p1","stLocal","sparkle","layerDepth","dotAmp","dotSize","sparkleNorm")}
    ${zs("p3","stLocal","sparkle","layerDepth","dotAmp","dotSize","sparkleNorm")}
    ${zs("p4","stLocal","sparkle","layerDepth","dotAmp","dotSize","sparkleNorm")}
    ${zs("p5","stLocal","sparkle","layerDepth","dotAmp","dotSize","sparkleNorm")}
    ${zs("p7","stLocal","sparkle","layerDepth","dotAmp","dotSize","sparkleNorm")}
...
`;var Ym=1.05;function Pc(e,t){let n=Ia(e);return t==="minimal"?Math.min(n,1):t==="reduced"?Math.min(n,2):n}function Fc(e,t){let n=Math.max(Ym,e);return t==="minimal"?Math.max(Ym,n*.68):t==="reduced"?Math.max(Ym,n*.84):n}u();function Oc(e){if(!Number.isFinite(e))return 3;let t=Math.round(e);return t<3?3:t>16?16:t}var ay=`
  ...
  return vec4(col, 1.0);
`;var KM=()=>1;function En(e,t){let o=(typeof e=="string"?e:t).replace("#","").trim();if(o.length!==6)return[0,0,0];let r=parseInt(o,16);return Number.isNaN(r)?[0,0,0]:[(r>>16&255)/255,(r>>8&255)/255,(r&255)/255]}function QM(e,t,n,o,r){return Zt(e,t.config,n,o,r(),t.templateKey)}function Km(e){return e.scale(()=>window.innerWidth/window.innerHeight,1)}function _o(e,t,n){let o=e.config.params?.[t];return typeof o=="string"?o:n}function ZM(e,t,n){return _n(e,t.config,n(),Xn)}function Qm(e,t,n){let o=t.config;return!o.syncBand||o.syncBand==="none"?0:So(e,o.syncBand,n(),void 0,o)*(o.syncMultiplier??.45)}function iy(e,t){let{hydra:n,hydraRef:o,effectKey:r,activeChannelRef:i,renderQualityRef:s,electricNoiseCirclePackRef:l,liveHydraBands:m}=t,{fillLayerSrc:d,shapeLayerSrc:y,superformulaSrc:D,plasmaSrc:B,patternNoiseSrc:O,patternCellsSrc:K,patternTilesSrc:X,patternPolarSrc:pe,patternGeometrySrc:Re,electricNoiseSrc:ge,plexusSrc:Fe,universeWithinSrc:Qe,fractalFoldSrc:Ze,topoContourSrc:dt,gaussianNoiseGrid:Et,noise:at,solid:nt,src:ft,s0:A,s1:M}=n,k=(re,we)=>QM(r,e,re,we,m),p=()=>e.config.params;switch(e.templateKey){case"fillLayer":return typeof d=="function"?Km(d(()=>En(p()?.colorA,"#7c3aed")[0],()=>En(p()?.colorA,"#7c3aed")[1],()=>En(p()?.colorA,"#7c3aed")[2],()=>En(p()?.colorB,"#06b6d4")[0],()=>En(p()?.colorB,"#06b6d4")[1],()=>En(p()?.colorB,"#06b6d4")[2],()=>Math.max(0,Math.min(3,Math.round(Number(k("type",1))))),()=>k("softness",.35),()=>Math.max(0,Math.min(3,Math.round(Number(k("sweep",0))))))):nt(1,0,0);case"noise":{let re=()=>Math.max(8,Math.min(8192,k("scale",1681))),we=()=>.22*Math.pow(Math.min(3,Math.max(0,Number(k("speed",.15)))),1.35);return Et!=null?Km(Et(()=>re(),()=>we())):Km(at(()=>Math.max(.05,re()*.12),()=>.02+we()*1.25).saturate(0))}case"plasma":return typeof B=="function"?B(()=>k("speed",1.1),()=>k("scale",1),()=>k("complexity",1)):nt(.5,.2,.9);case"patternLayer":{let re=()=>En(_o(e,"colorA","#0b1020"),"#0b1020")[0],we=()=>En(_o(e,"colorA","#0b1020"),"#0b1020")[1],Ye=()=>En(_o(e,"colorA","#0b1020"),"#0b1020")[2],Ue=()=>En(_o(e,"colorB","#22d3ee"),"#22d3ee")[0],Ne=()=>En(_o(e,"colorB","#22d3ee"),"#22d3ee")[1],qe=()=>En(_o(e,"colorB","#22d3ee"),"#22d3ee")[2],Je=()=>Math.max(0,Math.min(3,Math.round(Number(k("variant",2))))),Ht=()=>Math.max(0,Math.min(10,Math.round(Number(k("geometry",0))))),et=()=>k("scale",1),Dt=()=>k("speed",.4),gt=()=>k("warp",0),bt=()=>Ns(et()),Pt=()=>k("symmetry",2),vt=Math.max(0,Math.min(5,Math.round(Number(k("type",1))))),zt=Ri(()=>o.current?.o?.[3]);if(vt===4){o.current?.synth?.setFunction?.({name:"patternTuringDisplay",type:"src",inputs:[...la],glsl:Ha(En(_o(e,"colorA","#0b1020"),"#0b1020"),En(_o(e,"colorB","#22d3ee"),"#22d3ee"))});let bn=ie().patternTuringDisplay;return bn?bn(zt,Je,bt,Pt):ft(zt)}if(vt===5)return typeof Re=="function"?Re(Ht,et,Dt,gt,re,we,Ye,Ue,Ne,qe):nt(.1,.6,.9);let tn=vt===1?K:vt===2?X:vt===3?pe:O;return typeof tn=="function"?tn(Je,et,Dt,gt,re,we,Ye,Ue,Ne,qe):nt(.1,.6,.9)}case"electricNoise":{let re=()=>k("speed",1),we=()=>k("scale",1),Ye=()=>k("noiseScale",1),Ue=()=>k("turbulence",.2),Ne=()=>k("detail",5),qe=()=>k("intensity",1.4),Je=()=>k("rings",.85),Ht=()=>k("ringPower",.9),et=()=>En(_o(e,"color","#331a66"),"#331a66")[0],Dt=()=>En(_o(e,"color","#331a66"),"#331a66")[1],gt=()=>En(_o(e,"color","#331a66"),"#331a66")[2],bt=()=>l.current,Pt=()=>bt().count;return typeof ge=="function"?ge(kc(),re,we,Ye,Ue,Ne,qe,Je,Ht,KM,Ec(),Pt,et,Dt,gt):nt(.2,.1,.4)}case"plexus":return typeof Fe=="function"?Fe(()=>k("speed",1),()=>Fc(k("points",1.5),s.current),()=>k("intensity",1),()=>Pc(k("layers",4),s.current),()=>k("glow",1.2),()=>Qm(r,e,m)):nt(.4,.15,.85);case"topoContour":{let re=i.current===0?A:M;return typeof dt=="function"?dt(re,()=>k("scale",1),()=>Math.max(2,Math.min(24,Math.round(k("lines",10)))),()=>k("speed",1),()=>k("valley",.12),()=>k("lineWidth",1),()=>k("videoTint",.35),()=>Math.max(0,Math.min(1,Math.round(k("palette",0))))):nt(0,0,0)}case"universeWithin":return typeof Qe=="function"?Qe(()=>k("speed",1),()=>k("zoom",1.5),()=>Ia(k("layers",4)),()=>k("glow",1.2),()=>Qm(r,e,m)):nt(.4,.15,.85);case"fractalFold":return typeof Ze=="function"?Ze(()=>k("foldX",.86),()=>k("foldY",1.04),()=>k("zoom",1),()=>k("speed",.6),()=>k("spin",.42),()=>Oc(k("depth",8)),()=>k("glow",1.4),()=>k("hue",.12),()=>Qm(r,e,m)):nt(.15,.35,.9);case"shapeLayer":return typeof y=="function"?y(()=>Math.max(0,Math.min(4,Math.round(Number(k("shape",0))))),()=>k("size",.45),()=>k("roundness",0),()=>k("stroke",.15),()=>k("rotate",0),()=>k("centerX",.5),()=>k("centerY",.5),()=>En(_o(e,"color","#ffffff"),"#ffffff")[0],()=>En(_o(e,"color","#ffffff"),"#ffffff")[1],()=>En(_o(e,"color","#ffffff"),"#ffffff")[2],()=>ZM(r,e,m),()=>Math.max(0,Math.min(1,Math.round(Number(k("fill",0)))))):nt(1,1,1);case"superformula":return typeof D=="function"?D(()=>Math.max(0,Math.min(2,Math.round(Number(k("look",2))))),()=>k("m",7.6),()=>k("n1",.36),()=>k("n2",2.16),()=>k("size",.48),()=>k("speed",.35),()=>k("glow",1.2),()=>En(_o(e,"color","#c4b5fd"),"#c4b5fd")[0],()=>En(_o(e,"color","#c4b5fd"),"#c4b5fd")[1],()=>En(_o(e,"color","#c4b5fd"),"#c4b5fd")[2]):nt(.77,.71,.99);default:return null}}u();function td(e,t,n){let o=e?.params?.[t];return typeof o=="number"&&Number.isFinite(o)?o:n}u();function sy(e,t,n){let o=bc(e);if(!o)return;let r=n?.[o.layerId];if(!(!r||String(r.templateKey)!==t))return r.config}u();function nd(e){return e<=.04045?e/12.92:Math.pow((e+.055)/1.055,2.4)}function od(e){let t=e<=.0031308?e*12.92:1.055*Math.pow(e,.4166666666666667)-.055;return Math.min(1,Math.max(0,t))}function JM(e,t,n){let o=nd(e),r=nd(t),i=nd(n),s=Math.cbrt(.4122214708*o+.5363325363*r+.0514459929*i),l=Math.cbrt(.2119034982*o+.6806995451*r+.1073969566*i),m=Math.cbrt(.0883024619*o+.2817188376*r+.6299787005*i);return{L:.2104542553*s+.793617785*l-.0040720468*m,a:1.9779984951*s-2.428592205*l+.4505937099*m,b:.0259040371*s+.7827717662*l-.808675766*m}}function eL(e){let t=(e.L+.3963377774*e.a+.2158037573*e.b)**3,n=(e.L-.1055613458*e.a-.0638541728*e.b)**3,o=(e.L-.0894841775*e.a-1.291485548*e.b)**3;return[od(4.0767416621*t-3.3077115913*n+.2309699292*o),od(-1.2684380046*t+2.6097574011*n-.3413193965*o),od(-.0041960863*t-.7034186147*n+1.707614701*o)]}function tL(e,t){let n=Math.max(2,Math.min(4,Math.round(t)));if(e.length===0)return Array.from({length:n},(D,B)=>({L:B/(n-1),a:0,b:0}));let o=1/0,r=-1/0;for(let D of e)D.L<o&&(o=D.L),D.L>r&&(r=D.L);let i=Math.max(.001,r-o),s=Array.from({length:n},(D,B)=>({L:o+i*B/(n-1),a:0,b:0})),l=new Float64Array(n),m=new Float64Array(n),d=new Float64Array(n),y=new Int32Array(n);for(let D=0;D<6;D++){l.fill(0),m.fill(0),d.fill(0),y.fill(0);for(let B of e){let O=0,K=1/0;for(let X=0;X<n;X++){let pe=s[X],Re=B.L-pe.L,ge=B.a-pe.a,Fe=B.b-pe.b,Qe=Re*Re+ge*ge+Fe*Fe;Qe<K&&(K=Qe,O=X)}l[O]+=B.L,m[O]+=B.a,d[O]+=B.b,y[O]+=1}for(let B=0;B<n;B++){let O=y[B];O!==0&&(s[B]={L:l[B]/O,a:m[B]/O,b:d[B]/O})}}return s.toSorted((D,B)=>D.L-B.L)}var nL=.02;function oL(e,t,n=0,o=1){let r=Math.max(0,Math.min(1,t));if(Math.hypot(e.a,e.b)>=nL){let m=1+r*1.6;return{L:e.L,a:e.a*m,b:e.b*m}}let s=n/Math.max(1,o)*Math.PI*2+.6,l=r*.11;return{L:e.L,a:Math.cos(s)*l,b:Math.sin(s)*l}}var Gn={canvas:null,ctx:null,rgb:new Float32Array(12),lastMs:0,lastCount:0,seeded:!1};function rL(){if(Gn.ctx)return Gn.ctx;if(typeof document>"u")return null;let e=document.createElement("canvas");e.width=24,e.height=24;let t=e.getContext("2d",{willReadFrequently:!0});return t?(Gn.canvas=e,Gn.ctx=t,t):null}function aL(e,t,n){let o=e.length;for(let r=0;r<4;r++){let i=Math.min(r,o-1),s=e[i],[l,m,d]=eL(oL(s,t,i,o)),y=r*3;n?(Gn.rgb[y]=l,Gn.rgb[y+1]=m,Gn.rgb[y+2]=d):(Gn.rgb[y]+=(l-Gn.rgb[y])*.18,Gn.rgb[y+1]+=(m-Gn.rgb[y+1])*.18,Gn.rgb[y+2]+=(d-Gn.rgb[y+2])*.18)}}function ly(e,t,n,o){let r=t!==Gn.lastCount,i=o-Gn.lastMs>=120;if(!r&&!i)return Gn.rgb;let s=rL();if(!s||!e||e.readyState<2||e.videoWidth<2)return Gn.rgb;Gn.lastMs=o,Gn.lastCount=t,s.drawImage(e,0,0,24,24);let l=s.getImageData(0,0,24,24).data,m=[];for(let d=0;d<l.length;d+=4)m.push(JM(l[d]/255,l[d+1]/255,l[d+2]/255));return aL(tL(m,t),n,!Gn.seeded||r),Gn.seeded=!0,Gn.rgb}u();var Hc="vec3(0.299, 0.587, 0.114)",iL=e=>`
...
`;u();u();var sL={full:{blurGaussianTaps:8,blurRadialSteps:8,glowAura:!0,warpTunnelQuality:0},reduced:{blurGaussianTaps:4,blurRadialSteps:6,glowAura:!0,warpTunnelQuality:1},minimal:{blurGaussianTaps:4,blurRadialSteps:4,glowAura:!1,warpTunnelQuality:2}};function ca(e){return sL[e??"full"]}function py(e){return e<1e-5?0:Math.max(.001,e*.045)}function my(e){return e<1e-5?0:Math.min(.35,e*.17)}function dy(e){return ca(e).blurRadialSteps}var fy=[[-4,1/256],[-3,8/256],[-2,28/256],[-1,56/256],[0,70/256],[1,56/256],[2,28/256],[3,8/256],[4,1/256]],lL=[[-2,1/16],[-1,4/16],[0,6/16],[1,4/16],[2,1/16]],cL=[[-1,1/4],[0,2/4],[1,1/4]];function Ic(e){return ca(e).blurGaussianTaps>=8?lL:cL}var hy=24,_y=.2;function Bc(e,t){let n=new Set(t);for(let o of e)if(o!=null&&!n.has(o))return o;return null}u();function gy(e){return e<1e-5?0:Math.min(2,e*2)}function by(e){let t=Math.max(0,Math.min(1,e??0));return Math.min(1,t*2)}var yy=`
  vec4 sharp = _c0;
  vec4 soft = _c1;
  float a = clamp(amount, 0.0, 1.0);
...
`;u();function jL(e,t){let n=t;return`
    vec3 q${n} = ${e};
    float f${n} = 0.0;
...
`;u();function $1(e,t){return`
    ...
    ));`}function XL(e,t){return`${t} = fract(sin(${e} * 12345.564) * 7658.76);`}function q1(e,t,n){return`${n} = smoothstep(0.0, ${e}, ${t}) * smoothstep(1.0, ${e}, ${t});`}function YL(e,t,n,o,r){return`
    vec2 suv_${e} = ${t} * ${o};
    ...
    ${i} = trail_${e};`}function zc(e,t,n,o,r,i,s,l){return`
  {
...
`;function X1(e){return`
  ...
  ${zc("d0","uv","UV","tFall","rainAmt","staticScale","dropH","dropTrail")}

  float eps = 1.0 / min(resolution.x, resolution.y);
  float dropHx, dropTrailX;
  ${zc("dx","uv + vec2(eps, 0.0)","UV","tFall","rainAmt","staticScale","dropHx","dropTrailX")}

  float dropHy, dropTrailY;
  ${zc("dy","uv + vec2(0.0, eps)","UV","tFall","rainAmt","staticScale","dropHy","dropTrailY")}
...
`,K1=`
  ...
  float dropH, dropTrail;
  ${zc("o0","uv","UV","tFall","rainAmt","staticScale","dropH","dropTrail")}
...
`;u();var Uc="vec3(0.299, 0.587, 0.114)";function Q1(e,t,n){return`
  float ${n} = 0.0;
  for (int i = 1; i <= 28; i++) {
    vec2 p_${e} = psUv ${t} psDir * (float(i) * psStep);
    if (p_${e}.x < 0.001 || p_${e}.x > 0.999 || p_${e}.y < 0.001 || p_${e}.y > 0.999) break;
    float l_${e} = dot(texture2D(videoTex, p_${e}).rgb, ${Uc});
    if (l_${e} < psThr) break;
    ${n} = float(i) * psStep;
  }`}var Z1=`
  float a = clamp(amount, 0.0, 1.0);
  ...
  float psMyL = dot(texture2D(videoTex, psUv).rgb, ${Uc});
  ...
  if (psMyL >= psThr) {
    ...
    for (int i = 0; i < 20; i++) {
      ...
      float d_r = abs(dot(c_r, ${Uc}) - psTarget);
...
`)}function QL(){let e=xd.length,t=(e-1)/2,n=xd.reduce((r,i)=>r+i,0),o=[];for(let r=0;r<e;r++){let i=xd[r]/n,s=r-t,l=s===0?"st":`st + cell * ${s.toFixed(1)}`;o.push(rx(l,i))}return o.join(`
`)}function ZL(){let e=Vc.length,t=(e-1)/2,n=Vc.reduce((r,i)=>r+i,0),o=[];for(let r=0;r<e;r++)for(let i=0;i<e;i++){let s=Vc[i]*Vc[r]/(n*n),l=i-t,m=r-t,d=l===0&&m===0?"st":`st + vec2(${l.toFixed(1)}, ${m.toFixed(1)}) * cell`;o.push(rx(d,s))}return o.join(`
`)}var ax=`
  float a = clamp(amount, 0.0, 2.0);
  if (a < 0.00001) return _c0;
...
`;u();var ok=2.4,Rx=`
  ...
  vec3 flare = clamp(fan * (a * ${ok.toFixed(2)}), 0.0, 1.0);
...
`;u();var Hx=`(index + ${ea}.5) / ${Gr}.0`,rk=`(index + ${Yl}.5) / ${Gr}.0`,ak=`(index + 0.5) / ${Gr}.0`,jc="vec2((enc.r * 65280.0 + enc.g * 255.0) / 65535.0, (enc.b * 65280.0 + enc.a * 255.0) / 65535.0)",ik=`
    be = p1 - p0;
    bf = p3 - p0;
    bg = p0 - p1 + p2 - p3;
    bh = outUv - p0;
    ...
    edgeDist = min(edgeDist, length(pa - ba * ht));`}var sk=Array.from({length:wr},(e,t)=>`
    index = ${t}.0;
  ...
  if (maskLive > 0.5) {
    ...
    for (int i = 0; i < ${ka}; i++) {
      if (float(i) + 0.5 < n) {
        ...
        pi = ${jc};
        enc = texture2D(maskTex, vec2(${rk}, 0.5));
        header = ${jc};
...
`;function Ux(e){let t=e.setFunction;if(!t)return;t({name:"customKaleid",type:"coord",inputs:[{type:"float",name:"nSides",default:4},{type:"float",name:"angle",default:0}],glsl:`
        ...
        `}),t({name:"dataDrip",type:"coord",inputs:[{type:"float",name:"amount",default:0},{type:"float",name:"columns",default:72},{type:"float",name:"chaos",default:.35},{type:"float",name:"dance",default:.65},{type:"float",name:"speed",default:1}],glsl:`
          ...
          return st;
        `}),t({name:"liquix",type:"coord",inputs:[{type:"float",name:"amount",default:0},{type:"float",name:"pivot",default:.48},{type:"float",name:"bands",default:56},{type:"float",name:"speed",default:1.15}],glsl:U1}),t({name:"metalSphereScene",type:"color",inputs:[{type:"sampler2D",name:"tex",default:0},{type:"float",name:"amount",default:0},{type:"float",name:"sphereSize",default:1},{type:"float",name:"noiseAmt",default:.42},{type:"float",name:"detail",default:3.5},{type:"float",name:"speed",default:.75},{type:"float",name:"roughness",default:.1},{type:"float",name:"reflectAmt",default:1.05},{type:"float",name:"rotation",default:.35},{type:"float",name:"envAspect",default:1.777}],glsl:k1}),t({name:"warpTunnelColor",type:"color",inputs:[{type:"sampler2D",name:"videoTex",default:0},{type:"float",name:"amount",default:0},{type:"float",name:"tunnelSpeed",default:.55},{type:"float",name:"tunnelRefract",default:.72},{type:"float",name:"tunnelShine",default:.68},{type:"float",name:"tunnelArms",default:3},{type:"float",name:"tunnelFog",default:.62},{type:"float",name:"audioBoost",default:0},{type:"float",name:"tunnelQuality",default:0}],glsl:W1}),t({name:"pulseMarchColor",type:"color",inputs:[{type:"float",name:"amount",default:0},{type:"float",name:"morph",default:.55},{type:"float",name:"marchSpeed",default:1.1},{type:"float",name:"detail",default:4.5},{type:"float",name:"glow",default:.65}],glsl:F1}),t({name:"throughTheStarsOverlay",type:"combine",inputs:[{type:"float",name:"amount",default:0},{type:"float",name:"glow",default:.74}],glsl:E1}),t({name:"feedbackGrade",type:"color",inputs:[{type:"float",name:"balance",default:.5},{type:"float",name:"luminosity",default:0}],glsl:yx}),t({name:"ghostFlow",type:"color",inputs:[{type:"sampler2D",name:"prevTex",default:NaN},{type:"float",name:"amount",default:0},{type:"float",name:"melt",default:.62},{type:"float",name:"flowScale",default:.48},{type:"float",name:"refresh",default:0},{type:"float",name:"chromaBleed",default:.35}],glsl:xx}),t({name:"paletteRecolor",type:"color",inputs:[{type:"float",name:"amount",default:0},{type:"float",name:"mode",default:0},{type:"float",name:"count",default:3},{type:"float",name:"p0r",default:0},{type:"float",name:"p0g",default:0},{type:"float",name:"p0b",default:0},{type:"float",name:"p1r",default:.5},{type:"float",name:"p1g",default:.5},{type:"float",name:"p1b",default:.5},{type:"float",name:"p2r",default:1},{type:"float",name:"p2g",default:1},{type:"float",name:"p2b",default:1},{type:"float",name:"p3r",default:1},{type:"float",name:"p3g",default:1},{type:"float",name:"p3b",default:1}],glsl:Mx}),t({name:"shapeLayerSrc",type:"src",inputs:[{type:"float",name:"shape",default:0},{type:"float",name:"size",default:.45},{type:"float",name:"roundness",default:0},{type:"float",name:"stroke",default:.15},{type:"float",name:"rotate",default:0},{type:"float",name:"centerX",default:.5},{type:"float",name:"centerY",default:.5},{type:"float",name:"cr",default:1},{type:"float",name:"cg",default:1},{type:"float",name:"cb",default:1},{type:"float",name:"opacity",default:1},{type:"float",name:"shapeFill",default:0}],glsl:Tx}),t({name:"stringLayer",type:"color",inputs:[{type:"float",name:"amount",default:1},{type:"float",name:"tension",default:.42},{type:"float",name:"position",default:.5},{type:"float",name:"orientation",default:0},{type:"float",name:"thickness",default:.42},{type:"float",name:"glow",default:.68},{type:"float",name:"harmonics",default:2},{type:"float",name:"cr",default:.965},{type:"float",name:"cg",default:.929},{type:"float",name:"cb",default:.831}],glsl:Cx}),t({name:"resynthWarp",type:"coord",inputs:[{type:"float",name:"x",default:.5},{type:"float",name:"y",default:.78}],glsl:Sx}),t({name:"resynthTint",type:"color",inputs:[{type:"float",name:"x",default:.5},{type:"float",name:"y",default:.78},{type:"float",name:"hue",default:.25},{type:"float",name:"decay",default:.3}],glsl:wx}),t({name:"timeGlitchSlices",type:"color",inputs:[{type:"sampler2D",name:"sliceTex",default:0},{type:"float",name:"amount",default:0}],glsl:Wx}),t({name:"hitStreakExtract",type:"color",inputs:[{type:"float",name:"threshold",default:.6},{type:"float",name:"thinness",default:.55}],glsl:Lx}),t({name:"lens7cPrism",type:"color",inputs:[{type:"sampler2D",name:"prismTex",default:0},{type:"float",name:"amount",default:0},{type:"float",name:"throwLen",default:.12},{type:"float",name:"rotation",default:0},{type:"float",name:"threshold",default:.45},{type:"float",name:"haze",default:.5}],glsl:Rx})}u();u();u();var lk=[255,60,180],ck=[80,220,255],uk=[255,255,255];function Sd(e,t,n,o){return Number.isFinite(e)?Math.max(t,Math.min(n,e)):o}function Yc(e){let t=Number(e);return Number.isFinite(t)?t>1?Sd(t/24,.005,.35,.08):Sd(t,.005,.35,.08):.08}function uo(e,t){if(typeof e!="string"||!/^#[0-9a-fA-F]{6}$/.test(e))return t;let n=Number.parseInt(e.slice(1),16);return Number.isFinite(n)?[n>>16&255,n>>8&255,n&255]:t}function wd(e){return{horizontal:uo(e?.horizontalColor,lk),vertical:uo(e?.verticalColor,ck),cross:uo(e?.crossColor,uk)}}function Kc(e){return{decay:Number(e?.decay??1.25),thickness:Yc(e?.thickness),intersect:Sd(Number(e?.intersect??e?.defocus),0,3,1.6)}}function $x(){let e=document.createElement("canvas");e.width=320,e.height=180;let t=e.getContext("2d",{willReadFrequently:!0});if(!t)throw new Error("2d canvas unavailable");return{canvas:e,ctx:t,lines:[],lastUploadMs:0}}function pk(e,t){let n=Number.isFinite(t)&&t>.05?t:1.7777777777777777,o=512,r=Math.round(o/n);r>512&&(r=512,o=Math.round(r*n)),o=Math.max(160,o),r=Math.max(90,r),(e.canvas.width!==o||e.canvas.height!==r)&&(e.canvas.width=o,e.canvas.height=r)}function mk(e,t){let n=Math.max(0,e),o=Math.max(0,t),r=n+o;return r<=0?Math.random()<.5?"h":"v":Math.random()<n/r?"h":"v"}function Ii(e,t){let n=Math.max(0,Math.min(16,Math.round(t.spawn)));if(n<=0)return;let o=Math.max(0,t.horizontal),r=Math.max(0,t.vertical),i=Yc(t.thickness);for(let s=0;s<n;s++){e.lines.length>=96&&e.lines.shift();let l=mk(o,r);e.lines.push({axis:l,pos:.04+Math.random()*.92,life:1,width:i*(.65+Math.random()*.7)})}e.lastUploadMs=0}function Ks(e){return{spawn:Number(e?.spawn??4),horizontal:Number(e?.horizontal??1),vertical:Number(e?.vertical??1),thickness:Yc(e?.thickness)}}function qx(e,t,n){let o=Math.max(.5,n)*Math.max(0,t),r=[];for(let i=0;i<e.lines.length;i++){let s=e.lines[i],l=s.life-o;l>.008&&r.push({...s,life:l})}e.lines=r}function Xc([e,t,n],o){return`rgba(${e},${t},${n},${o})`}function dk(e,t){let o=Math.round(e[0]*.65+89.25),r=Math.round(e[1]*(1-.35)+255*.35),i=Math.round(e[2]*(1-.35)+255*.35);return`rgba(${o},${r},${i},${t})`}function fk(e){let t=Math.pow(Math.max(.004,e)/.08,.55);return[{scale:.35+5.15*t,alpha:.08},{scale:.3+2.9*t,alpha:.14},{scale:.25+1.55*t,alpha:.28},{scale:.2+.8*t,alpha:.72},{scale:.15+.2*t,alpha:.95}]}function Vx(e,t,n,o,r,i,s,l){let m=i*Math.min(o,r),d=fk(i);e.lineCap="round";for(let y=0;y<d.length;y++){let D=d[y];if(e.strokeStyle=y===d.length-1?dk(l,D.alpha*s):Xc(l,D.alpha*s),e.lineWidth=Math.max(.25,m*D.scale),e.beginPath(),t==="h"){let B=n*r;e.moveTo(0,B),e.lineTo(o,B)}else{let B=n*o;e.moveTo(B,0),e.lineTo(B,r)}e.stroke()}}function hk(e,t,n,o,r,i){let s=Math.max(0,o);if(s<.04)return;e.save(),e.globalCompositeOperation="lighter",e.lineCap="round";let l=[{r:r*2.8,alpha:.12},{r:r*1.6,alpha:.22},{r:r*.75,alpha:.55}];for(let m=0;m<l.length;m++){let d=l[m];e.fillStyle=Xc(i,d.alpha*s),e.beginPath(),e.arc(t,n,d.r,0,Math.PI*2),e.fill()}e.strokeStyle=Xc(i,.85*s),e.lineWidth=Math.max(1,r*.35),e.beginPath(),e.moveTo(t-r*3.2,n),e.lineTo(t+r*3.2,n),e.moveTo(t,n-r*3.2),e.lineTo(t,n+r*3.2),e.stroke(),e.fillStyle=Xc(i,s),e.beginPath(),e.arc(t,n,r*.28,0,Math.PI*2),e.fill(),e.restore()}function _k(e,t,n){pk(e,n);let{ctx:o,canvas:r,lines:i}=e,s=r.width,l=r.height;if(o.setTransform(1,0,0,1,0,0),o.globalCompositeOperation="source-over",o.fillStyle="rgba(0,0,0,1)",o.fillRect(0,0,s,l),i.length===0)return;let m=Yc(t.thickness),d=Math.max(0,Math.min(3,t.intersect)),{horizontal:y,vertical:D,cross:B}=t.colors;o.globalCompositeOperation="lighter";let O=i.filter(X=>X.axis==="h"),K=i.filter(X=>X.axis==="v");for(let X=0;X<O.length;X++){let pe=O[X];Vx(o,"h",pe.pos,s,l,pe.width||m,pe.life,y)}for(let X=0;X<K.length;X++){let pe=K[X];Vx(o,"v",pe.pos,s,l,pe.width||m,pe.life,D)}if(d>.01&&O.length>0&&K.length>0){let X=Math.min(s,l)*m*.55;for(let pe=0;pe<O.length;pe++){let Re=O[pe],ge=Re.pos*l;for(let Fe=0;Fe<K.length;Fe++){let Qe=K[Fe],Ze=Qe.pos*s,dt=Math.min(1,Re.life*Qe.life*d);hk(o,Ze,ge,dt,X,B)}}}}function Td(e,t,n,o,r,i=12){if(!e?.tex||!t)return!1;let s=t.lines.length>0?0:i;if(t.lastUploadMs>0&&r-t.lastUploadMs<s)return!1;_k(t,n,o);let l=e.tex;typeof l.resize=="function"&&(l.width!==t.canvas.width||l.height!==t.canvas.height)&&l.resize(t.canvas.width,t.canvas.height);try{l.subimage(t.canvas)}catch{return!1}return t.lastUploadMs=r,!0}var jx=1920,Xx=540,gk=512,Qc=[28,60,255],Zc=[255,154,26],Jc=[255,246,200];function Kx(){let e=document.createElement("canvas");e.width=jx,e.height=Xx;let t=e.getContext("2d",{alpha:!0});if(!t)throw new Error("2d canvas unavailable");t.imageSmoothingEnabled=!0;let n=document.createElement("canvas");n.width=jx,n.height=Xx;let o=n.getContext("2d",{alpha:!0});if(!o)throw new Error("2d scratch canvas unavailable");return o.imageSmoothingEnabled=!0,{canvas:e,ctx:t,scratch:n,scratchCtx:o,bins:new Float32Array(gk),lastUploadMs:0}}function Qx(e,t,n,o=.42){let r=Math.max(0,Math.min(1,n)),i=e[t];e[t]=i+(r-i)*o}function Yx(e,t,n){return[Math.round(e[0]+(t[0]-e[0])*n),Math.round(e[1]+(t[1]-e[1])*n),Math.round(e[2]+(t[2]-e[2])*n)]}function bk(e,t=Qc,n=Zc,o=Jc){let r=Math.max(0,Math.min(1,e));return r<=.5?Yx(t,n,r*2):Yx(n,o,(r-.5)*2)}function Zx(e){return{colorLo:uo(e?.colorLo,Qc),colorMid:uo(e?.colorMid,Zc),colorHi:uo(e?.colorHi,Jc)}}function Jx(e,t,n,o){if(!t.length||!Number.isFinite(n)||n<=0)return;let r=Math.max(0,Math.min(n,o)),i=Math.floor(r/n*t.length),s=t[Math.max(0,Math.min(t.length-1,i))]??.5,l=e.bins,m=l.length,d=o*2.4;for(let y=0;y<m;y++){let D=y/Math.max(1,m-1),B=Math.exp(-Math.pow((D-.12)/.09,2))*.85+Math.exp(-Math.pow((D-.35)/.14,2))*.55+Math.exp(-Math.pow((D-.62)/.18,2))*.35+Math.exp(-Math.pow((D-.85)/.12,2))*.22,O=.85+.15*Math.sin(d+D*9);Qx(l,y,s*B*O*1.15,.35)}}function ev(e,t,n){let o=t.kick??0,r=t.low??0,i=t.mid??0,s=t.high??0,l=t.master??(r+i+s)/3,m=e.bins,d=m.length;for(let y=0;y<d;y++){let D=y/Math.max(1,d-1),B=Math.exp(-Math.pow((D-.06)/.05,2))*o,O=Math.exp(-Math.pow((D-.18)/.1,2))*r,K=Math.exp(-Math.pow((D-.45)/.16,2))*i,X=Math.exp(-Math.pow((D-.78)/.14,2))*s,pe=l*.12*(.7+.3*Math.sin(n*6+D*14));Qx(m,y,Math.min(1,B*1.1+O+K+X+pe),.4)}}function yk(e,t){let n=e.length;if(n===0)return 0;let o=Math.max(0,Math.min(n-1,t)),r=Math.floor(o),i=Math.min(n-1,r+1),s=o-r,l=s*s*(3-2*s);return e[r]+(e[i]-e[r])*l}function Cd(e,t,n,o,r,i,s,l,m,d=1){e.lineWidth=i,e.lineCap="round",e.lineJoin="round";let y=r>1400?2:1,D=Math.max(0,Math.min(1,d));for(let B=0;B<r-y;B+=y){let O=(o[B]+o[B+y])*.5,[K,X,pe]=bk(O,s,l,m);e.strokeStyle=`rgba(${K},${X},${pe},${D})`,e.beginPath(),e.moveTo(t[B],n[B]),e.lineTo(t[B+y],n[B+y]),e.stroke()}}function xk(e,t,n,o,r,i,s,l,m){let d=t.length,y=new Float32Array(n),D=new Float32Array(n),B=new Float32Array(n),O=Math.max(1,n-1),K=i===2?1:i===1?.7:.22;for(let X=0;X<n;X++){let pe=X/O*(d-1),Re=Math.max(0,Math.min(1,yk(t,pe)));B[X]=Re,y[X]=X+.5,D[X]=o-Re*r*K}if(e.globalCompositeOperation="source-over",i>=1){let[X,pe,Re]=m;e.beginPath(),e.moveTo(0,o);for(let Fe=0;Fe<n;Fe++)e.lineTo(y[Fe],D[Fe]);e.lineTo(n,o),e.closePath();let ge=e.createLinearGradient(0,o-r,0,o);ge.addColorStop(0,`rgba(${X},${pe},${Re},0.12)`),ge.addColorStop(.7,`rgba(${X},${pe},${Re},0.04)`),ge.addColorStop(1,`rgba(${X},${pe},${Re},0)`),e.fillStyle=ge,e.globalAlpha=1,e.fill()}if(Cd(e,y,D,B,n,Math.max(2.2,Math.min(4,r*.04)),s,l,m,.45),Cd(e,y,D,B,n,Math.max(1,Math.min(1.8,r*.016)),s,l,m,1),i===2){let X=new Float32Array(n);for(let pe=0;pe<n;pe++)X[pe]=o+(o-D[pe]);Cd(e,y,X,B,n,Math.max(.9,r*.014),s,l,m,.55)}e.globalAlpha=1,e.globalCompositeOperation="source-over"}function Md(e,t){let{ctx:n,canvas:o,scratch:r,scratchCtx:i,bins:s}=e,l=o.width,m=o.height,d=Math.max(.15,Math.min(.97,t.persistence)),y=Math.round(t.mode),D=typeof t.colorLo=="string"?uo(t.colorLo,Qc):t.colorLo??Qc,B=typeof t.colorMid=="string"?uo(t.colorMid,Zc):t.colorMid??Zc,O=typeof t.colorHi=="string"?uo(t.colorHi,Jc):t.colorHi??Jc,K=m*Math.max(.55,Math.min(.96,t.positionY)),X=m*Math.max(.2,Math.min(.55,t.scale*.85)),pe=Math.max(7,Math.round(m*(.016+(1-d)*.014)));n.setTransform(1,0,0,1,0,0),i.setTransform(1,0,0,1,0,0),i.globalCompositeOperation="copy",i.drawImage(o,0,0),i.globalCompositeOperation="source-over",n.globalCompositeOperation="source-over",n.globalAlpha=1,n.fillStyle="#000",n.fillRect(0,0,l,m);let Re=.82+d*.16;n.globalAlpha=Re,n.drawImage(r,0,-pe),n.globalAlpha=1;let ge=Math.max(16,m*.12),Fe=n.createLinearGradient(0,0,0,ge);Fe.addColorStop(0,"rgba(0,0,0,0.35)"),Fe.addColorStop(1,"rgba(0,0,0,0)"),n.fillStyle=Fe,n.fillRect(0,0,l,ge),xk(n,s,l,K,X,y,D,B,O)}function tv(e,t,n,o,r=12){if(!e?.tex||!t||t.lastUploadMs>0&&o-t.lastUploadMs<r)return!1;Md(t,n);let i=e.tex;typeof i.resize=="function"&&(i.width!==t.canvas.width||i.height!==t.canvas.height)&&i.resize(t.canvas.width,t.canvas.height);try{i.subimage(t.canvas)}catch{return!1}return t.lastUploadMs=o,!0}u();var vk=960,Sk=540,nv=['system-ui, -apple-system, "Segoe UI", sans-serif','ui-monospace, "SF Mono", "Cascadia Code", monospace','Impact, "Arial Narrow", Haettenschweiler, sans-serif','Georgia, "Times New Roman", serif','"Segoe UI Variable", "Segoe UI", "Trebuchet MS", sans-serif'];function ov(){return{animStartMs:0,lastMessage:"",lastAnim:-1,glitchPhase:0}}function rv(){let e=document.createElement("canvas");e.width=vk,e.height=Sk;let t=e.getContext("2d",{willReadFrequently:!0});if(!t)throw new Error("2d canvas unavailable");return{canvas:e,ctx:t,lastUploadMs:0}}function wk(e){let t=Math.max(0,Math.min(1,e));return 1-Math.pow(1-t,3)}function Tk(e){let t=Math.max(.15,e.animSpeed),n=Math.round(e.anim);if(n===0||n===4)return 1;let o=n===3?2200/t:900/t;return wk((e.nowMs-e.animStartMs)/o)}function Ck(e){let t=Math.max(.15,e.animSpeed),n=e.nowMs*.001*t*3.2;return .72+.28*Math.sin(n)}function Mk(e,t){let n=Math.max(.15,e.animSpeed),o=Math.sin(e.nowMs*.017*n+t*4.7+e.animStartMs*.003);return o>.55?(o-.55)*48:0}function Lk(e){let t=Math.max(.15,e.animSpeed),n=Math.sin(e.nowMs*.031*t+e.animStartMs*.01);return n>.2?1:.35+.25*Math.max(0,n)}function Ld([e,t,n],o){return`rgba(${e},${t},${n},${Math.max(0,Math.min(1,o))})`}function av(e){let t=e?.message;return{message:typeof t=="string"&&t.trim()?t:"YOUR MESSAGE",size:Number(e?.size??.085),positionX:Number(e?.positionX??.5),positionY:Number(e?.positionY??.82),align:Math.round(Number(e?.align??1)),font:Math.round(Number(e?.font??0)),weight:Math.round(Number(e?.weight??1)),tracking:Number(e?.tracking??.02),color:uo(e?.color,[255,255,255]),glow:Number(e?.glow??.35),shadow:Number(e?.shadow??.5),anim:Math.round(Number(e?.anim??0)),animSpeed:Number(e?.animSpeed??.85)}}function eu(e,t){return{...av(e?.params),size:Zt("textLayer",e,"size",.085,t),positionX:Zt("textLayer",e,"positionX",.5,t),positionY:Zt("textLayer",e,"positionY",.82,t),tracking:Zt("textLayer",e,"tracking",.02,t),glow:Zt("textLayer",e,"glow",.35,t),shadow:Zt("textLayer",e,"shadow",.5,t),animSpeed:Zt("textLayer",e,"animSpeed",.85,t)}}function kk(e,t){let n=Math.max(0,Math.min(1,t.amount));if(n<.004)return;let{ctx:o,canvas:r}=e,i=r.width,s=r.height;o.setTransform(1,0,0,1,0,0),o.clearRect(0,0,i,s);let l=av({message:t.message,size:t.size,positionX:t.positionX,positionY:t.positionY,align:t.align,font:t.font,weight:t.weight,tracking:t.tracking,color:`rgb(${t.color.join(",")})`,glow:t.glow,shadow:t.shadow,anim:t.anim,animSpeed:t.animSpeed}),m=l.anim,d=Tk({...t,...l}),y=n,D=0,B=1,O=l.message;if(m===1)y*=d;else if(m===2)y*=d,D=(1-d)*s*.06;else if(m===3){let ft=Math.floor(d*l.message.length);O=l.message.slice(0,Math.max(0,ft)),y*=Math.max(.35,d)}else m===4?(B=Ck({...t,...l}),y*=.85+.15*B):m===5&&(y*=Lk({...t,...l}));if(y<.01||!O.trim())return;let K=Math.max(0,Math.min(nv.length-1,l.font)),X=Math.max(14,Math.min(s*.28,l.size*s)),pe=l.weight>=1?"700":"500";o.font=`${pe} ${X}px ${nv[K]}`,o.textBaseline="middle";let Re=Math.max(0,Math.min(2,l.align)),ge=["left","center","right"];o.textAlign=ge[Re];let Fe=O.split(`
`),Qe=X*1.22,Ze=Qe*Fe.length,dt=l.positionX*i,Et=l.positionY*s-Ze*.5+Qe*.5+D,at=l.tracking*X;"letterSpacing"in o&&(o.letterSpacing=`${at}px`);let nt=(ft,A,M,k)=>{let p=0;m===5&&(p=Mk({...t,...l},k)),l.shadow>.02&&(o.save(),o.globalAlpha=y*l.shadow*.85,o.fillStyle="rgba(0,0,0,0.92)",o.shadowColor="rgba(0,0,0,0.75)",o.shadowBlur=X*.12,o.shadowOffsetX=X*.03,o.shadowOffsetY=X*.04,o.fillText(ft,A+p,M),o.restore()),l.glow>.02&&(o.save(),o.globalAlpha=y*l.glow*.55,o.fillStyle=Ld(l.color,1),o.shadowColor=Ld(l.color,.95),o.shadowBlur=X*(.18+l.glow*.42),o.fillText(ft,A+p,M),o.restore()),o.save(),o.globalAlpha=y,o.fillStyle=Ld(l.color,1),m===4?(o.translate(A+p,M),o.scale(B,B),o.fillText(ft,0,0)):o.fillText(ft,A+p,M),o.restore()};for(let ft=0;ft<Fe.length;ft++)nt(Fe[ft],dt,Et+ft*Qe,ft)}function tu(e,t,n,o,r=16){if(!e?.tex||!t||t.lastUploadMs>0&&o-t.lastUploadMs<r)return!1;kk(t,n);let i=e.tex;return typeof i.resize=="function"&&(i.width!==t.canvas.width||i.height!==t.canvas.height)&&i.resize(t.canvas.width,t.canvas.height),i.subimage(t.canvas),t.lastUploadMs=o,!0}u();function nu(){return{...ov(),prevEnvelope:0}}function iv(e){let{bundle:t,s3:n,bindState:o,fxCfg:r,bands:i,amount:s,now:l,envelope:m,binding:d,runtime:y,shouldBind:D}=e;if(!n?.tex||s<.004)return;let B=eu(r,i),O=B.message!==y.lastMessage,K=B.anim!==y.lastAnim,X=m>.02&&y.prevEnvelope<=.02;O||K||y.animStartMs<=0?(y.animStartMs=l,y.lastMessage=B.message,y.lastAnim=B.anim):jn(d)&&X&&(y.animStartMs=l),y.prevEnvelope=m,D&&ho(n,t.canvas,"textLayer",o),tu(n,t,{message:B.message,size:B.size,positionX:B.positionX,positionY:B.positionY,align:B.align,font:B.font,weight:B.weight,tracking:B.tracking,color:B.color,glow:B.glow,shadow:B.shadow,anim:B.anim,animSpeed:B.animSpeed,amount:s,nowMs:l,animStartMs:y.animStartMs},l,12)}u();function No(e,t,n,o){return Number.isFinite(e)?Math.max(t,Math.min(n,e)):o}function Qn(e,t,n){return e+(t-e)*n}function sv(e,t,n){let o=No((n-e)/Math.max(1e-6,t-e),0,1,0);return o*o*(3-2*o)}function Rk(e,t,n,o){let r=Number.isFinite(t)&&t>.05?t:1.7777777777777777,i,s;if(n!==void 0&&o!==void 0&&n>=160&&o>=90){i=Math.round(n),s=Math.round(o);let l=Math.max(i,s);if(l>4096){let m=4096/l;i=Math.max(160,Math.round(i*m)),s=Math.max(90,Math.round(s*m))}}else i=Math.min(4096,1920),s=Math.round(i/r),s>4096&&(s=4096,i=Math.round(s*r)),i=Math.max(160,i),s=Math.max(90,s);return(e.canvas.width!==i||e.canvas.height!==s)&&(e.canvas.width=i,e.buffer.width=i,e.canvas.height=s,e.buffer.height=s,e.lastUploadMs=0),{w:i,h:s}}function kd(){return{u:.04+Math.random()*.92,v:.04+Math.random()*.92,z:Math.random()*Qn(.22,.48,Math.random()),brightness:.45+Math.random()*.55,size:.55+Math.random()*.65,px:-9999,py:-9999}}function lv(e){if(typeof e!="string"||!/^#[0-9a-fA-F]{6}$/.test(e))return[0,232,204];let t=Number.parseInt(e.slice(1),16);return Number.isFinite(t)?[t>>16&255,t>>8&255,t&255]:[0,232,204]}function cv(){let e=document.createElement("canvas"),t=document.createElement("canvas");e.width=320,e.height=180,t.width=320,t.height=180;let n=e.getContext("2d",{willReadFrequently:!0}),o=t.getContext("2d",{willReadFrequently:!0});if(!n||!o)throw new Error("2d canvas unavailable");return{canvas:e,ctx:n,buffer:t,bufferCtx:o,stars:[],lastUploadMs:0}}function uv(e){let t=No(e,12,220,56);return Math.max(8,Math.min(462,Math.round(t*2.1)))}function Ak(e,t){let n=No(e,0,1.5,.48),o=No(t,0,1,.78);return No(n*Qn(.52,1.72,o),0,1.5,.48)}function Ek(e,t){let n=uv(t),{stars:o}=e;if(o.length!==n){if(o.length<n){for(let r=o.length;r<n;r++)o.push(kd());return}o.length=n}}function Rd(e,t,n){let o=uv(t),r=[];for(let l=0;l<o;l++)r.push(kd());e.stars=r,e.lastUploadMs=0;let{w:i,h:s}={w:e.canvas.width,h:e.canvas.height};e.ctx.fillStyle="#000",e.ctx.fillRect(0,0,i,s),e.bufferCtx.fillStyle="#000",e.bufferCtx.fillRect(0,0,i,s)}function Pk(e,t,n,o,r,i,s){let l=e.z,m=Qn(.2,.52,s),d=sv(0,m,l),y=1-sv(.86,1,l),D=d*y,B=e.u-t,O=e.v-n,K=1+l*l*Qn(.35,1.65,i),X=(t+B*K)*o,pe=(n+O*K)*r,Re=Qn(.18,.62,l)*Qn(.8,1.05,s);return{x:X,y:pe,fade:D,pointScale:Re}}function pv(e,t,n){let r=Ak(t.trail,t.amount??.78)/1.5,i=No(t.speed,0,8,1),s=No(t.glow,0,1,.72),l=No(t.fov,.25,2,1),m=No(t.depth,0,1,.65),d=No(t.density,12,220,52),y=No(t.centerX,0,1,.5),D=No(t.centerY,0,1,.5),B=Math.max(.001,Math.min(.05,t.dt)),[O,K,X]=t.tint;Ek(e,d);let{w:pe,h:Re}=Rk(e,n,t.pixelWidth,t.pixelHeight),ge=pe/512,Fe=y*pe,Qe=D*Re,Ze=No(t.amount??.78,0,1,.78),dt=B*i*Qn(.2,.72,m)*Qn(.88,1.28,Ze),Et=1+(6e-4+i*.0042)*r*Qn(.45,2.6,m),at=r<.007?1:1-r*Qn(.018,.075,1-r*.45),nt=r<.007?0:r*Qn(.72,.99,s),{ctx:ft,bufferCtx:A,buffer:M,canvas:k}=e;A.setTransform(1,0,0,1,0,0),A.globalCompositeOperation="source-over",A.globalAlpha=1,A.fillStyle=`rgba(0,0,0,${at.toFixed(4)})`,A.fillRect(0,0,pe,Re),r>.007&&nt>.01&&(A.save(),A.globalAlpha=nt,A.translate(Fe,Qe),A.scale(Et,Et),A.translate(-Fe,-Qe),A.drawImage(k,0,0,pe,Re),A.restore());let p=r>.03,re=Qn(.75,1,s),we=Qn(.55,1.85,r)*Qn(.75,1.15,s)*Qn(1,1.35,i/8)*ge,Ye=.52;for(let Ue=0;Ue<e.stars.length;Ue++){let Ne=e.stars[Ue];Ne.z+=dt*Qn(.85,1.15,Ne.size),Ne.z>=1&&Object.assign(Ne,kd());let{x:qe,y:Je,fade:Ht,pointScale:et}=Pk(Ne,y,D,pe,Re,l,m),Dt=Ne.brightness*re*Ht;if(Dt<.004)continue;p&&Ne.px>-9e3&&Ht>.08&&(A.strokeStyle=`rgba(${O},${K},${X},${(Dt*Qn(.3,.88,r)*s).toFixed(3)})`,A.lineWidth=we*Ne.size*et*Ye,A.lineCap="round",A.beginPath(),A.moveTo(Ne.px,Ne.py),A.lineTo(qe,Je),A.stroke());let gt=Qn(.22,.62,Ne.size)*et*Qn(.82,1.02,s)*ge*Ye;s>.08&&Ht>.08&&(A.fillStyle=`rgba(${O},${K},${X},${(Dt*s*.62).toFixed(3)})`,A.beginPath(),A.arc(qe,Je,gt*Qn(2.8,5.5,s),0,Math.PI*2),A.fill()),A.fillStyle=`rgba(255,255,255,${Dt.toFixed(3)})`,A.beginPath(),A.arc(qe,Je,gt,0,Math.PI*2),A.fill(),Ne.px=qe,Ne.py=Je}ft.setTransform(1,0,0,1,0,0),ft.globalCompositeOperation="source-over",ft.globalAlpha=1,ft.drawImage(M,0,0,pe,Re),e.lastUploadMs=0}function Ad(e,t,n,o,r,i=0){if(!e?.tex||r-t.lastUploadMs<i)return!1;pv(t,n,o);let s=e.tex;return(s.width!==t.canvas.width||s.height!==t.canvas.height)&&s.resize?.(t.canvas.width,t.canvas.height),s.subimage(t.canvas),t.lastUploadMs=r,!0}u();function mv(e,t,n){let o="throughTheStars";return{density:Zt(o,e,"density",56,t),speed:Zt(o,e,"speed",1.15,t),trail:Zt(o,e,"trail",.48,t),glow:Zt(o,e,"glow",.74,t),fov:Zt(o,e,"fov",1.05,t),depth:Zt(o,e,"depth",.65,t),centerX:Zt(o,e,"centerX",.5,t),centerY:Zt(o,e,"centerY",.5,t),tint:lv(e?.params?.tint),dt:n}}function dv(e){let{bundle:t,s3:n,bindState:o,fxCfg:r,bands:i,amount:s,dt:l,now:m,aspect:d,pixelWidth:y,pixelHeight:D,shouldBind:B=!0}=e;if(!n?.tex||s<=1e-5)return;B&&ho(n,t.canvas,"throughTheStars",o);let O={...mv(r,i,l),amount:s,pixelWidth:y,pixelHeight:D};Ad(n,t,O,d,m,0)}function fv(e){let{bundle:t,s3:n,bindState:o,fxCfg:r,bands:i,amount:s,aspect:l,now:m,pixelWidth:d,pixelHeight:y}=e;return!n?.tex||s<=1e-5?!1:(ho(n,t.canvas,"throughTheStars",o),t.lastUploadMs=0,Ad(n,t,{...mv(r,i,1/60),amount:s,pixelWidth:d,pixelHeight:y},l,m,0))}u();u();function hv(e,t){return .58+(1-Ho(e)*.22)*.4+Ho(t)*.32}function _v(e,t){if(t<=1e-4)return 1;let n=e/t;return n>=1?1:n<=0?0:n*n*(3-2*n)}function gv(e){return .22+Ho(e)*.78}function Fk(e){let t=(e%1+1)%1*6,n=Math.floor(t),o=t-n,r=1-o;switch(n){case 0:return[1,o,0];case 1:return[r,1,0];case 2:return[0,1,o];case 3:return[0,r,1];case 4:return[o,0,1];default:return[1,0,r]}}function bv(e,t,n,o,r){let i=Ho(o);if(i<.008)return{r:e,g:t,b:n};let[s,l,m]=Fk(r),d=i*.2,y=e*(1-d)+s*d,D=t*(1-d)+l*d,B=n*(1-d)+m*d,O=.299*e+.587*t+.114*n,K=.299*y+.587*D+.114*B;if(K<1e-5)return{r:y,g:D,b:B};let X=O/K;return{r:Math.min(1,y*X),g:Math.min(1,D*X),b:Math.min(1,B*X)}}function yv(e){return e>=.4?1:e<=0?0:e/.4}function Ed(e,t,n=.09){let o=Math.min(e,1-e),r=Math.min(t,1-t),i=Math.min(o,r);if(i>=n)return 1;if(i<=0)return 0;let s=i/n;return s*s*(3-2*s)}function xv(e){return .7+Ho(e)*.65}function vv(e,t,n){let o=.05+Ho(n)*.2;return!Number.isFinite(e)||e<0||Math.abs(e-t)>=o?!0:e<t*(.6+Ho(n)*.22)}function Sv(e,t,n,o,r){let i=Math.max(0,Math.min(o-1,Math.floor(t*o))),s=Math.max(0,Math.min(r-1,Math.floor(n*r)));return e[s*o+i]??0}function wv(e,t,n,o,r){return r*.9+e*.16+t*.1+n*.08+o*14e-5}var ou=.08,Ok=.82;function Tv(e,t){return Math.hypot(e-.5,t-.5)}function Cv(e,t,n,o){let r=(.18+Ho(n)*.24+Ho(o)*.16)*Math.max(0,t);return Math.min(Ok,Math.max(ou,e)+r)}function Mv(e,t,n,o=!1){if(!o&&t>n)return-1;let r=1-t/Math.max(n,1e-4);return Math.max(0,e)*(.42+r*.58)}var Qs=.86,Hk=.8;function Lv(e){return e>=Qs}function kv(e,t){return e>=Qs&&t<Hk}function Pd(e,t,n){if(e<=0||n<=0)return 0;let o=Math.round(e*(3.2+Ho(t)*3.4));return Math.min(n,Math.max(e,o))}var Ik=.16,Bk=.9;function Bi(e,t){let n=Math.max(0,Math.round(e)),o=Math.max(0,Math.round(t)),r=Math.max(80,Math.min(420,Math.round(n*Ik))),i=Math.max(0,n-r),s=Math.min(o,i),l=Math.max(0,o-i);return{reserveHold:r,baseCap:i,baseFree:Math.max(0,i-s),reserveFree:Math.max(0,r-l)}}function Rv(e,t){let n=Math.max(0,e);return Math.max(t*1.08,n*Bk,.78)}function Fd(e,t){return e>=t||e>=Qs}function Av(e,t,n,o,r,i){if(e<=0||i<=0)return 0;let s=Ho(n),l=Ho(r);if(t){let d=Math.round((28+l*110)*(.4+s*.75)*(.65+Ho(o)*.55));return Math.min(i,Math.max(8,d))}let m=Math.max(2,Math.round(e*.014*s*(.55+l*.7)));return Math.min(i,m)}function Ev(e,t,n,o,r){if(e<=0)return 0;let i=Math.max(0,o)+Math.max(0,r);if(i<=0)return 0;let s=Ho(n),l=t?Math.max(10,Math.round(e*.2*(.5+s))):Math.max(3,Math.round(e*.07*(.45+s)));return Math.min(i,l)}function Ho(e){return Number.isFinite(e)?Math.max(0,Math.min(1,e)):0}var Zs=4096,Dk=512,po=128,Wo=72,Nk=18e3,Ov=.95,Wk=.32,Gk=.64,zk=5;function gn(e,t,n,o){return Number.isFinite(e)?Math.max(t,Math.min(n,e)):o}function Uk(e){return gn(e,.4,1.8,1)}function Hv(e){return .32+gn(e,0,1,.65)*1.28}function Vk(e){return Math.round(2500+gn(e,0,1,.5)*13500)}function $k(e){return .4+gn(e,0,1,.55)*.6}function qk(e){return Math.round(16-gn(e,0,1,.55)*8)}function Pv(e,t){let n=Math.sin(e*127.1+t*311.7)*43758.5453;return n-Math.floor(n)}function Iv(e,t,n){let o=n*.001,r=0,i=0,s=.55,l=e*5.5+o*.31,m=t*5.5+o*.27;for(let d=0;d<4;d++)r+=(Pv(l,m)-.5)*s,i+=(Pv(l+17.3,m+11.1)-.5)*s,l*=2.1,m*=2.1,s*=.5;return[r,i]}function Bv(e,t,n,o){let r=e-.5,i=t-.5,s=Math.hypot(r,i)+1e-4,l=r/s,m=i/s,d=-m,y=l,D=(e<.5?-1+e*2:(e-.5)*2)*(1-Math.abs(r)*1.6),B=(t<.5?-1+t*2:(t-.5)*2)*(1-Math.abs(i)*1.6),O=Math.sin(n*.0031+e*13.5+t*9.2+o)*.7+Math.cos(n*.0024-e*8.4+t*11.7+o*.61)*.3,K=.42+Math.min(s*1.8,.58);return[l*K+d*O*.92+D*.38,m*K+y*O*.92+B*.38]}function jk(e,t,n,o,r){let i=Number.isFinite(t)&&t>.05?t:1.7777777777777777,s=gn(n,.35,1,.55),l,m;if(o!==void 0&&r!==void 0&&o>=160&&r>=90){l=Math.round(o*s),m=Math.round(r*s);let d=Math.max(l,m);if(d>Zs){let y=Zs/d;l=Math.max(160,Math.round(l*y)),m=Math.max(90,Math.round(m*y))}}else l=Math.min(Zs,1920),m=Math.round(l/i),m>Zs&&(m=Zs,l=Math.round(m*i)),l=Math.max(160,l),m=Math.max(90,m);return(e.canvas.width!==l||e.canvas.height!==m)&&(e.canvas.width=l,e.buffer.width=l,e.canvas.height=m,e.buffer.height=m,e.lastUploadMs=0),{w:l,h:m}}function Dv(){let e=document.createElement("canvas"),t=document.createElement("canvas"),n=document.createElement("canvas");e.width=320,e.height=180,t.width=320,t.height=180,n.width=po,n.height=Wo;let o=e.getContext("2d",{willReadFrequently:!0}),r=t.getContext("2d",{willReadFrequently:!0}),i=n.getContext("2d",{willReadFrequently:!0});if(!o||!r||!i)throw new Error("2d canvas unavailable");return{canvas:e,ctx:o,buffer:t,bufferCtx:r,sampleCanvas:n,sampleCtx:i,lumaData:null,particles:[],lastUploadMs:0,turbPhase:0,burstPhase:0,lastSampleMs:0,spreadRadius:ou,prevLuma:null}}function el(e){e.particles.length=0,e.lumaData=null,e.lastUploadMs=0,e.turbPhase=0,e.burstPhase=0,e.lastSampleMs=0,e.spreadRadius=ou,e.prevLuma=null;let{w:t,h:n}={w:e.canvas.width,h:e.canvas.height};e.ctx.fillStyle="#000",e.ctx.fillRect(0,0,t,n),e.bufferCtx.fillStyle="#000",e.bufferCtx.fillRect(0,0,t,n)}function Xk(e,t,n,o,r){if(!e.lumaData)r=!0;else if(!r||n-e.lastSampleMs<o)return!0;return!t||t.readyState<2||t.videoWidth<2?(e.lumaData=null,!1):(e.sampleCtx.drawImage(t,0,0,po,Wo),e.lumaData=e.sampleCtx.getImageData(0,0,po,Wo).data,e.lastSampleMs=n,!0)}function Yk(e){let t=po*Wo,n=new Float32Array(t),o=new Float32Array(t),r=new Float32Array(t),i=new Float32Array(t);for(let s=0;s<t;s++){let l=s*4,m=e[l]/255,d=e[l+1]/255,y=e[l+2]/255;n[s]=.299*m+.587*d+.114*y,o[s]=m,r[s]=d,i[s]=y}return{luma:n,cr:o,cg:r,cb:i}}function Kk(e){let t=0;for(let n=0;n<e.length;n+=4){let o=(.299*e[n]+.587*e[n+1]+.114*e[n+2])/255;o>t&&(t=o)}return Math.max(Wk,t*Gk)}function Qk(e,t){for(let r=0;r<e.particles.length;r++){let i=e.particles[r];if(!i.active)return i}let n=Math.min(Nk,Math.max(1500,t));if(e.particles.length>=n)return null;let o={active:!1,attached:!0,u:0,v:0,vx:0,vy:0,life:0,maxLife:1,age:0,seed:0,lightU:0,lightV:0,castLuma:0,size:Ov,r:1,g:1,b:1};return e.particles.push(o),o}function Js(e){let t=0;for(let n=0;n<e.particles.length;n++)e.particles[n].active&&t++;return t}function Zk(e){let t=new Uint8Array(po*Wo);for(let n=0;n<e.particles.length;n++){let o=e.particles[n];if(!o.active||!o.attached)continue;let r=Math.floor(o.v*Wo)*po+Math.floor(o.u*po);r>=0&&r<t.length&&(t[r]=Math.min(255,t[r]+1))}return t}function Jk(e,t,n,o,r,i=!1){let s=Qk(e,r);s&&(s.active=!0,s.attached=!0,s.u=Math.max(.002,Math.min(.998,t.u+n)),s.v=Math.max(.002,Math.min(.998,t.v+o)),s.lightU=t.u,s.lightV=t.v,s.castLuma=t.luma,s.vx=0,s.vy=0,s.maxLife=12,s.life=s.maxLife,s.age=i?8:0,s.seed=Math.random(),s.size=Ov*(i?1.02+Math.random()*.28:.84+Math.random()*.32),s.r=t.r,s.g=t.g,s.b=t.b)}function e3(e,t,n,o,r,i,s){let l=[];for(let m=0;m<Wo;m++)for(let d=0;d<po;d++){let y=m*po+d,D=e.luma[y];if(D<n)continue;let B=Fd(D,i)?r:o;if(t[y]>=B)continue;let O=Tv((d+.5)/po,(m+.5)/Wo),K=Mv(D,O,s,Lv(D));K<0||l.push({px:d,py:m,idx:y,slots:B-t[y],score:K})}return l.sort((m,d)=>d.score-m.score),l}function t3(e,t,n,o){if(!t||t.length!==e.luma.length)return[];let r=[];for(let i=0;i<Wo;i++)for(let s=0;s<po;s++){let l=i*po+s;kv(e.luma[l],t[l])&&(n[l]>=o||r.push({px:s,py:i,idx:l,slots:o-n[l],score:e.luma[l]}))}return r.sort((i,s)=>s.score-i.score),r}function ru(e,t){(!e.prevLuma||e.prevLuma.length!==t.luma.length)&&(e.prevLuma=new Float32Array(t.luma.length)),e.prevLuma.set(t.luma)}function n3(e){let t=0;for(let n=0;n<e.luma.length;n++){let o=e.luma[n];o>t&&(t=o)}return t}function Fv(e,t,n,o){if(n<=0)return 0;let r=[];for(let s=0;s<e.particles.length;s++){let l=e.particles[s];if(!l.active||!l.attached||l.age<.28)continue;let m=Math.floor(l.v*Wo)*po+Math.floor(l.u*po),d=m>=0&&m<t.luma.length?t.luma[m]:0;d>=o||r.push({i:s,luma:d,age:l.age})}r.sort((s,l)=>s.luma-l.luma||l.age-s.age);let i=0;for(let s=0;s<r.length&&i<n;s++)e.particles[r[s].i].active=!1,i++;return i}function o3(e,t,n){let o=n*po+t;return{u:(t+.5)/po,v:(n+.5)/Wo,luma:e.luma[o],r:e.cr[o],g:e.cg[o],b:e.cb[o]}}function Od(e,t,n,o,r,i,s,l,m=!1){if(n.length===0||o<=0)return 0;let d=0,y=o;for(;y>0;){let D=!1;for(let B=0;B<n.length&&!(y<=0);B++){let O=n[B];if(O.slots<=0)continue;let K=o3(t,O.px,O.py),X=(Math.random()-.5)*i*.95,pe=(Math.random()-.5)*s*.95;Jk(e,K,X,pe,l,m),O.slots--,r[O.idx]=(r[O.idx]??0)+1,d++,y--,D=!0}if(!D)break}return d}function r3(e,t,n,o,r,i,s){if(o<1e-4){ru(e,t);return}let l=Vk(i),m=.3+gn(r,0,1,.55)*5.2;e.burstPhase+=s*m;let d=e.burstPhase>=1;d&&(e.burstPhase-=1),e.spreadRadius=Cv(e.spreadRadius,s,o,r);let y=Zk(e),D=1/po,B=1/Wo,O=n3(t),K=Rv(O,n),X=t3(t,e.prevLuma,y,5);if(X.length>0){let M=Bi(l,Js(e)),k=M.reserveFree+M.baseFree,p=Pd(X.length,o,Math.max(k,X.length*4));k<p&&(Fv(e,t,p-k,Qs),M=Bi(l,Js(e)),k=M.reserveFree+M.baseFree),Od(e,t,X,Pd(X.length,o,k),y,D,B,l,!0)}let pe=.32+o*(.22+r*.28);if(!d&&Math.random()>pe){ru(e,t);return}let Re=.55+gn(i,0,1,.5)*.9,ge=d?Math.max(1,Math.round((zk+Math.round(gn(r,0,1,.55)*4))*Re)):1,Fe=ge+2,Qe=d?n*(.93-gn(r,0,1,.55)*.08):n,Ze=e3(t,y,Qe,ge,Fe,K,e.spreadRadius);if(Ze.length===0){ru(e,t);return}let dt=[],Et=[];for(let M=0;M<Ze.length;M++){let k=Ze[M];Fd(t.luma[k.idx],K)?dt.push(k):Et.push(k)}let at=Bi(l,Js(e));dt.length>0&&at.reserveFree+at.baseFree<8&&(Fv(e,t,8,K),at=Bi(l,Js(e)));let nt=Av(Et.length,d,o,r,i,at.baseFree);Od(e,t,Et,nt,y,D,B,l);let ft=Bi(l,Js(e)),A=Ev(dt.length,d,o,ft.reserveFree,ft.baseFree);Od(e,t,dt,A,y,D,B,l),ru(e,t)}function a3(e,t,n,o){e.attached=!1;let r=gn(o,0,1,.45),[i,s]=Iv(e.u,e.v,t.turbPhase),[l,m]=Bv(e.u,e.v,t.turbPhase,e.u*97+e.v*53),d=r*n;e.vx=l*.1*d+i*25e-5*n,e.vy=m*.1*d+s*25e-5*n,e.maxLife=xv(r),e.life=e.maxLife}function i3(e,t,n,o){let r=gn(n.turbulence,0,1,.45),i=.4+(1-gn(n.detach,0,1,.26))*1.35,s=o*(3.2+r*4.8);e.turbPhase+=o*1e3;for(let l=0;l<e.particles.length;l++){let m=e.particles[l];if(!m.active)continue;if(m.age+=o,m.attached){let Re=Sv(t.luma,m.lightU,m.lightV,po,Wo);(vv(Re,m.castLuma,n.stick)||m.age>i)&&a3(m,e,n.amount,n.turbulence);continue}let[d,y]=Iv(m.u,m.v,e.turbPhase),[D,B]=Bv(m.u,m.v,e.turbPhase,l*17.3+m.u*41),O=r*n.amount,K=22e-5*n.amount*(.55+r*.7);m.vx+=d*K*o,m.vy+=y*K*o,m.vx+=(D*.0021+d*38e-5)*O*o,m.vy+=(B*.0021+y*38e-5)*O*o;let X=Ed(m.u,m.v),pe=.32+X*.68;m.u+=m.vx*s*pe,m.v+=m.vy*s*pe,m.life-=o*(.85+r*.2+(1-X)*1.4),(m.life<=0||m.u<0||m.u>1||m.v<0||m.v>1)&&(m.active=!1)}}function s3(e,t,n,o,r,i,s,l,m,d,y){if(r<.004)return;let D=Uk(s),B=Hv(l),O=gv(m),K=Math.max(.22,o.size*i*D*O),X=gn(l,0,1,.65)*.08,pe=bv(o.r,o.g,o.b,d,y),Re=Math.round(Math.min(255,(pe.r+X)*255)),ge=Math.round(Math.min(255,(pe.g+X)*255)),Fe=Math.round(Math.min(255,(pe.b+X)*255)),Qe=r*B*(o.attached?.9:.62),Ze=K*1.45;e.fillStyle=`rgba(${Re},${ge},${Fe},${(Qe*.16).toFixed(3)})`,e.fillRect(t-Ze,n-Ze,Ze*2,Ze*2),e.fillStyle=`rgba(${Re},${ge},${Fe},${Qe.toFixed(3)})`,e.fillRect(t-K,n-K,K*2,K*2)}function l3(e,t,n,o,r=performance.now()){if(n.amount<=1e-5)return;let i=Math.max(.001,Math.min(.05,n.dt)),s=$k(n.quality),l=qk(n.quality),{w:m,h:d}=jk(e,o,s,n.pixelWidth,n.pixelHeight),y=m/Dk;if(!Xk(e,t,r,l,!n.skipVideoSample)||!e.lumaData)return;let B=e.lumaData,O=Kk(B),K=Yk(B);r3(e,K,O,n.amount,n.burst,n.density,i),i3(e,K,n,i);let X=gn(n.trail,0,1,.5)*1.15,pe=1-X*.052,Re=X*.92,{ctx:ge,bufferCtx:Fe,buffer:Qe,canvas:Ze}=e;Fe.setTransform(1,0,0,1,0,0),Fe.globalCompositeOperation="source-over",Fe.globalAlpha=1,Fe.drawImage(Ze,0,0,m,d),Fe.globalAlpha=pe,Fe.fillStyle="#000",Fe.fillRect(0,0,m,d),Fe.globalAlpha=1;let dt=Hv(n.brightness),Et=gn(n.spectral,0,1,.52);for(let at=0;at<e.particles.length;at++){let nt=e.particles[at];if(!nt.active)continue;let ft=_v(nt.age,hv(n.burst,nt.seed)),A=nt.attached?1:yv(nt.life/nt.maxLife),M=nt.attached?1:Ed(nt.u,nt.v),k=ft*A*M*n.amount*dt*(nt.attached?.96:.55+Re*.38),p=wv(nt.u,nt.v,nt.age,e.turbPhase,nt.seed);s3(Fe,nt.u*m,nt.v*d,nt,k,y,n.size,n.brightness,ft,Et,p)}ge.setTransform(1,0,0,1,0,0),ge.globalCompositeOperation="source-over",ge.globalAlpha=1,ge.drawImage(Qe,0,0,m,d),e.lastUploadMs=0}function Id(e,t,n){return{amount:gn(t,0,1,.8),stick:gn(Number(e?.stick??.65),0,1,.65),detach:gn(Number(e?.detach??.26),0,1,.26),burst:gn(Number(e?.burst??.58),0,1,.58),turbulence:gn(Number(e?.turbulence??.48),0,1,.48),size:gn(Number(e?.size??1),.4,1.8,1),brightness:gn(Number(e?.brightness??.68),0,1,.68),spectral:gn(Number(e?.spectral??.52),0,1,.52),density:gn(Number(e?.density??.5),0,1,.5),quality:gn(Number(e?.quality??.55),0,1,.55),trail:gn(Number(e?.trail??.5),0,1,.5),skipVideoSample:!1,dt:n}}function Bd(e,t,n,o,r,i,s=0){if(!e?.tex||i-t.lastUploadMs<s)return!1;l3(t,n,o,r,i);let l=e.tex;return(l.width!==t.canvas.width||l.height!==t.canvas.height)&&l.resize?.(t.canvas.width,t.canvas.height),l.subimage(t.canvas),t.lastUploadMs=i,!0}u();function Nv(e){let{bundle:t,s3:n,bindState:o,video:r,params:i,amount:s,dt:l,now:m,aspect:d,pixelWidth:y,pixelHeight:D,shouldBind:B=!0,skipVideoSample:O=!1}=e;!n?.tex||s<=1e-5||(B&&ho(n,t.canvas,"lumaDust",o),Bd(n,t,r,{...Id(i,s,l),pixelWidth:y,pixelHeight:D,skipVideoSample:O},d,m,0))}function Wv(e){let{bundle:t,s3:n,bindState:o,video:r,params:i,amount:s,aspect:l,now:m,pixelWidth:d,pixelHeight:y}=e;return!n?.tex||s<=1e-5?!1:(ho(n,t.canvas,"lumaDust",o),t.lastUploadMs=0,Bd(n,t,r,{...Id(i,s,1/60),pixelWidth:d,pixelHeight:y},l,m,0))}u();var zv=1920,Uv=1080,Gv=2560,Di=48,Ni=27,Nd=5,c3=[255,42,42],u3=[255,176,32];function wo(e,t,n,o){return Number.isFinite(e)?Math.max(t,Math.min(n,e)):o}function Wd(e,t,n){return{amount:wo(t,0,1,0),count:Math.round(wo(Number(e?.count),1,Nd,3)),threshold:wo(Number(e?.threshold),0,1,.42),smooth:wo(Number(e?.smooth),0,1,.76),size:wo(Number(e?.size),.4,2.2,1),links:wo(Number(e?.links),0,1,.7),color:uo(e?.color,c3),labelColor:uo(e?.labelColor,u3),dt:Number.isFinite(n)?Math.max(.001,Math.min(.08,n)):1/60,skipVideoSample:!1}}function p3(e,t){let n=Math.round(wo(e,0,1,0)*999),o=Math.round(wo(t,0,1,0)*999);return`x: ${n} y: ${o}`}function m3(e,t){let n=.028+wo(e,0,1,.76)*.4;return 1-Math.exp(-Math.max(t,1/240)/n)}function d3(e,t,n){let o=new Float32Array(t*n);for(let r=0;r<o.length;r++){let i=r*4;o[r]=(.2126*e[i]+.7152*e[i+1]+.0722*e[i+2])/255}return o}function f3(e,t,n,o,r,i){let s=Math.max(.12,i*.55),l=0,m=0;for(;o+l+1<t&&e[r*t+o+l+1]>=s;)l++;for(;o-l-1>=0&&e[r*t+o-l-1]>=s;)l++;for(;r+m+1<n&&e[(r+m+1)*t+o]>=s;)m++;for(;r-m-1>=0&&e[(r-m-1)*t+o]>=s;)m++;let d=Math.max(l,m,1);return wo((d*2+1)/Math.max(t,n),.045,.28,.09)}function h3(e,t,n,o,r){let i=Math.round(wo(o,1,Nd,3)),s=wo(r,0,1,.42),l=Math.max(.08,s*.45),m=[];for(let D=1;D<n-1;D++)for(let B=1;B<t-1;B++){let O=D*t+B,K=e[O];if(K<l)continue;let X=!0;for(let pe=-1;pe<=1&&X;pe++)for(let Re=-1;Re<=1;Re++)Re===0&&pe===0||e[(D+pe)*t+(B+Re)]>K&&(X=!1);X&&m.push({i:O,luma:K})}m.sort((D,B)=>B.luma-D.luma);let d=.14,y=[];for(let D of m){if(y.length>=i)break;let B=D.i%t,O=Math.floor(D.i/t),K=(B+.5)/t,X=(O+.5)/n;D.luma<s&&y.length>0||y.some(Re=>Math.hypot(Re.u-K,Re.v-X)<d)||y.push({u:K,v:X,size:f3(e,t,n,B,O,D.luma),luma:D.luma})}return y}var _3=[{u:.42,v:.48,size:.1,luma:.82},{u:.61,v:.36,size:.075,luma:.7},{u:.52,v:.64,size:.068,luma:.64},{u:.28,v:.3,size:.055,luma:.52},{u:.74,v:.58,size:.05,luma:.48}];function g3(e,t,n,o,r,i){let s=Math.round(wo(n,1,Nd,3)),l=m3(o,r),m=Math.min(1,r*4.2),d=Math.min(1,r*2.4),y=new Set,D=[],B=e.toSorted((O,K)=>K.alpha-O.alpha);for(let O of B){let K=-1,X=.22;for(let pe=0;pe<t.length;pe++){if(y.has(pe))continue;let Re=t[pe],ge=Math.hypot(O.u-Re.u,O.v-Re.v);ge<X&&(X=ge,K=pe)}if(K>=0){let pe=t[K];y.add(K),D.push({id:O.id,u:O.u+(pe.u-O.u)*l,v:O.v+(pe.v-O.v)*l,size:O.size+(pe.size-O.size)*l,luma:O.luma+(pe.luma-O.luma)*l,alpha:Math.min(1,O.alpha+m)})}else{let pe=Math.max(0,O.alpha-d);pe>.02&&D.push({...O,alpha:pe})}}for(let O=0;O<t.length&&D.length<s;O++){if(y.has(O))continue;let K=t[O];D.push({id:i.nextId++,u:K.u,v:K.v,size:K.size,luma:K.luma,alpha:m})}return D.slice(0,s)}function b3(e){let t=e.filter(o=>o.alpha>.02),n=[];for(let o=0;o<t.length;o++)for(let r=o+1;r<t.length;r++)n.push([t[o],t[r]]);return n}function y3(e,t,n){let o=zv,r=Uv;if(t!==void 0&&n!==void 0&&t>=640&&n>=360){o=Math.round(t),r=Math.round(n);let i=Math.max(o,r);if(i>Gv){let s=Gv/i;o=Math.max(640,Math.round(o*s)),r=Math.max(360,Math.round(r*s))}}(e.canvas.width!==o||e.canvas.height!==r)&&(e.canvas.width=o,e.canvas.height=r)}function Vv(){let e=document.createElement("canvas");e.width=zv,e.height=Uv;let t=e.getContext("2d");if(!t)throw new Error("2d canvas unavailable");let n=document.createElement("canvas");n.width=Di,n.height=Ni;let o=n.getContext("2d",{willReadFrequently:!0});if(!o)throw new Error("2d canvas unavailable");return{canvas:e,ctx:t,sampleCanvas:n,sampleCtx:o,luma:new Float32Array(Di*Ni),hasSample:!1,tracks:[],nextId:1,lastUploadMs:0,lastSampleMs:0}}function Gd(e){e.tracks.length=0,e.hasSample=!1,e.lastUploadMs=0,e.lastSampleMs=0,e.ctx.setTransform(1,0,0,1,0,0),e.ctx.clearRect(0,0,e.canvas.width,e.canvas.height)}function x3(e,t,n,o){if(!o&&e.hasSample&&n-e.lastSampleMs<50)return;if(!t||t.readyState<2||t.videoWidth<2){e.hasSample=!1;return}e.sampleCtx.drawImage(t,0,0,Di,Ni);let r=e.sampleCtx.getImageData(0,0,Di,Ni).data;e.luma=d3(r,Di,Ni),e.hasSample=!0,e.lastSampleMs=n}function Dd([e,t,n],o){return`rgba(${e},${t},${n},${Math.max(0,Math.min(1,o))})`}function v3(e,t){let{ctx:n,canvas:o}=e,r=o.width,i=o.height;n.setTransform(1,0,0,1,0,0),n.clearRect(0,0,r,i);let s=wo(t.amount,0,1,0);if(s<.004)return;let l=wo(t.size,.4,2.2,1),m=r/1920,d=Math.max(1.5,2.2*m),y=Math.max(18,Math.round(24*m)),D=Math.max(4,6*m),B=wo(t.links,0,1,0);if(n.lineJoin="miter",n.lineCap="round",n.textAlign="left",n.textBaseline="bottom",n.font=`600 ${y}px ui-monospace, "SF Mono", "Cascadia Code", monospace`,B>.004){n.setLineDash([8*m,6*m]),n.lineWidth=Math.max(1.1,1.4*m);for(let[O,K]of b3(e.tracks)){let X=s*B*Math.min(O.alpha,K.alpha);X<.02||(n.strokeStyle=Dd(t.color,X*.82),n.beginPath(),n.moveTo(O.u*r,O.v*i),n.lineTo(K.u*r,K.v*i),n.stroke())}n.setLineDash([])}for(let O of e.tracks){let K=s*O.alpha;if(K<.02)continue;let X=O.u*r,pe=O.v*i,Re=O.size*Math.min(r,i)*l*.5,ge=X-Re,Fe=pe-Re,Qe=Re*2;n.strokeStyle=Dd(t.color,K),n.lineWidth=d,n.strokeRect(ge+.5,Fe+.5,Qe,Qe),n.fillStyle=Dd(t.labelColor,K),n.fillText(p3(O.u,O.v),ge,Fe-D)}}function zd(e,t,n,o,r,i=0){if(!e?.tex||o.amount<=1e-5||t.lastUploadMs>0&&r-t.lastUploadMs<i)return!1;y3(t,o.pixelWidth,o.pixelHeight),x3(t,n,r,!o.skipVideoSample);let s=t.hasSample?h3(t.luma,Di,Ni,o.count,o.threshold):_3.slice(0,o.count);t.tracks=g3(t.tracks,s,o.count,o.smooth,o.dt,t),v3(t,o);let l=e.tex;return typeof l.resize=="function"&&(l.width!==t.canvas.width||l.height!==t.canvas.height)&&l.resize(t.canvas.width,t.canvas.height),l.subimage(t.canvas),t.lastUploadMs=r,!0}u();function $v(e){let{bundle:t,s3:n,bindState:o,video:r,params:i,amount:s,dt:l,now:m,shouldBind:d=!0,skipVideoSample:y=!1,pixelWidth:D,pixelHeight:B}=e;!n?.tex||s<=1e-5||(d&&ho(n,t.canvas,"lumaLock",o),zd(n,t,r,{...Wd(i,s,l),skipVideoSample:y,pixelWidth:D,pixelHeight:B},m,0))}function qv(e){let{bundle:t,s3:n,bindState:o,video:r,params:i,amount:s,now:l,pixelWidth:m,pixelHeight:d}=e;return!n?.tex||s<=1e-5?!1:(ho(n,t.canvas,"lumaLock",o),t.lastUploadMs=0,zd(n,t,r,{...Wd(i,s,1/60),pixelWidth:m,pixelHeight:d},l,0))}u();function jv(e){return Math.round(e)>=1}function S3(e,t,n){typeof e.resize=="function"&&(e.width===t&&e.height===n||e.resize(t,n))}function Xv(){let e=document.createElement("canvas");e.width=2,e.height=2;let t=e.getContext("2d",{willReadFrequently:!0});if(!t)throw new Error("2d canvas unavailable");return{canvas:e,ctx:t,lastUpdateMs:0,lastPath:""}}function w3(e,t){let n=Math.max(e,t),o=n>256?256/n:1;return{w:Math.max(2,Math.round(e*o)),h:Math.max(2,Math.round(t*o))}}function T3(e,t){let n=t.videoWidth,o=t.videoHeight;if(!n||!o)return!1;let{w:r,h:i}=w3(n,o);return(e.canvas.width!==r||e.canvas.height!==i)&&(e.canvas.width=r,e.canvas.height=i),e.ctx.setTransform(1,0,0,1,0,0),e.ctx.drawImage(t,0,0,r,i),!0}function Yv(e,t,n,o){if(!e?.tex||!n||!t||t.videoWidth<=0||!(o.force||n.lastPath!==o.videoPath)||!T3(n,t))return!1;let i=e.tex;S3(i,n.canvas.width,n.canvas.height);try{i.subimage(n.canvas)}catch{return!1}return n.lastUpdateMs=o.now,n.lastPath=o.videoPath,!0}u();function Kv(){return{prevEnvelope:0,prevBand:0,followCooldownMs:0}}function Qv(e){let{bundle:t,s3:n,bindState:o,params:r,spawn:i,draw:s,dt:l,now:m,aspect:d,envelope:y,binding:D,bands:B,runtime:O,shouldBind:K=!0}=e;if(n?.tex){if(K&&ho(n,t.canvas,"neonGrid",o),jn(D))O.prevBand=0;else{let X=Mr(D.source,B,D.depth),pe=X>.35&&O.prevBand<=.35;O.followCooldownMs=Math.max(0,O.followCooldownMs-l*1e3),(pe||X>.55&&O.followCooldownMs<=0)&&(Ii(t,i),O.followCooldownMs=120),O.prevBand=X}O.prevEnvelope=y,qx(t,l,s.decay),Td(n,t,{...s,dt:l,colors:wd(r)},d,m,K?0:999999)}}function Zv(e,t){e.lines=[];let n=Math.max(3,Math.round(t.spawn));Ii(e,{...t,spawn:n,horizontal:1,vertical:0}),Ii(e,{...t,spawn:n,horizontal:0,vertical:1}),e.lastUploadMs=0}function Jv(e){let{bundle:t,s3:n,bindState:o,params:r,draw:i,aspect:s,now:l}=e;return!n?.tex||t.lines.length===0?!1:(ho(n,t.canvas,"neonGrid",o),t.lastUploadMs=0,Td(n,t,{...i,dt:0,colors:wd(r)},s,l,0))}function e2(e){let{settingsRef:t,backingWidth:n,backingHeight:o,oscilloscopeBundleRef:r,neonGridBundleRef:i,textLayerBundleRef:s,throughTheStarsBundleRef:l,lumaDustBundleRef:m,lumaLockBundleRef:d,metalEnvBundleRef:y,s3OverlayBindRef:D,textLayerRuntimeRef:B,oscilloscopeBridgeReadyRef:O,neonGridBridgeReadyRef:K,textLayerBridgeReadyRef:X,throughTheStarsBridgeReadyRef:pe,lumaDustBridgeReadyRef:Re,lumaLockBridgeReadyRef:ge,metalEnvBridgeReadyRef:Fe,neonGridWasEnabledRef:Qe,textLayerWasEnabledRef:Ze,throughTheStarsWasEnabledRef:dt,lumaDustWasEnabledRef:Et,lumaLockWasEnabledRef:at}=e;if(co("neonGrid"))try{let nt=Kx();r.current=nt,ie().oscilloscopeWaveformBundle=nt;let ft=$x();i.current=ft,K.current=!0;let A=rv();s.current=A,X.current=!0;let M=cv();l.current=M,pe.current=!0;let k=Dv();m.current=k,Re.current=!0;let p=Vv();d.current=p,ge.current=!0,Fa("neonGrid",ft.canvas,D.current),Fa("textLayer",A.canvas,D.current),Fa("throughTheStars",M.canvas,D.current),Fa("lumaDust",k.canvas,D.current),Fa("lumaLock",p.canvas,D.current),Fa("oscilloscope",nt.canvas,D.current);for(let Dt=0;Dt<36;Dt++){let gt=.85+.15*Math.sin(Dt*.45);for(let bt=0;bt<nt.bins.length;bt++){let Pt=bt/Math.max(1,nt.bins.length-1);nt.bins[bt]=(Math.exp(-Math.pow((Pt-.14)/.1,2))*.7+Math.exp(-Math.pow((Pt-.42)/.16,2))*.45+Math.exp(-Math.pow((Pt-.72)/.14,2))*.28)*gt}Md(nt,{persistence:.72,positionY:.88,scale:.55,mode:0,colorLo:"#1c3cff",colorMid:"#ff9a1a",colorHi:"#fff6c8"})}nt.lastUploadMs=-999,ft.lastUploadMs=-999,O.current=!0;let re=Xv();y.current=re,Fe.current=!0;let we=ko(t.current,"neonGrid")?.config;if(we){let Dt=Ks(we.params);Zv(ft,Dt),Jv({bundle:ft,s3:co("neonGrid"),bindState:D.current,params:we.params,draw:Kc(we.params),aspect:window.innerWidth/Math.max(1,window.innerHeight),now:performance.now()}),Qe.current=!0}let Ye=ko(t.current,"textLayer")?.config;if(Ye){let Dt=eu(Ye,ie().customBands);B.current=nu(),B.current.animStartMs=performance.now(),B.current.lastMessage=Dt.message,B.current.lastAnim=Dt.anim,tu(co("textLayer"),A,{...Dt,amount:Ye.base??.92,nowMs:performance.now(),animStartMs:B.current.animStartMs},performance.now(),0),Ze.current=!0}let Ue=ko(t.current,"throughTheStars"),Ne=Ue?.config;Ne&&(Rd(M,Number(Ne.params?.density??56),Number(Ne.params?.depth??.65)),fv({bundle:M,s3:co("throughTheStars"),bindState:D.current,fxCfg:Ne,bands:ie().customBands,amount:_n(Ue.effectKey,Ne,ie().customBands,Xn),aspect:window.innerWidth/Math.max(1,window.innerHeight),now:performance.now(),pixelWidth:n,pixelHeight:o}),dt.current=!0);let qe=ko(t.current,"lumaDust"),Je=qe?.config;Je&&(el(k),Wv({bundle:k,s3:co("lumaDust"),bindState:D.current,video:ie().s0?.src,params:Je.params,amount:_n(qe.effectKey,Je,ie().customBands,Xn),aspect:window.innerWidth/Math.max(1,window.innerHeight),now:performance.now(),pixelWidth:n,pixelHeight:o}),Et.current=!0);let Ht=ko(t.current,"lumaLock"),et=Ht?.config;et&&(Gd(p),qv({bundle:p,s3:co("lumaLock"),bindState:D.current,video:ie().s0?.src,params:et.params,amount:_n(Ht.effectKey,et,ie().customBands,Xn),now:performance.now(),pixelWidth:n,pixelHeight:o}),at.current=!0)}catch{Fe.current=!1,O.current=!1,K.current=!1,X.current=!1,pe.current=!1,Re.current=!1,ge.current=!1}}u();u();u();function tl(e,t){e&&(e.speed=t),ie().speed=t}u();function C3(e,t,n){return e>n&&t<=n}function t2(){return{prevBands:{},stemHitsSeen:new Set,counts:{},envelopes:{},shapeOriginMs:{},queues:{},anims:{}}}function n2(e){e.prevBands={},e.stemHitsSeen.clear(),e.counts={},e.envelopes={},e.shapeOriginMs={},e.queues={},e.anims={}}function o2(e){if(Object.keys(e.anims).length>0)return!0;for(let t in e.queues){let n=e.queues[t];if(n&&n.length>0)return!0}return!1}function au(e,t,n,o,r){let{attack:i,release:s,decay:l,hold:m}=o,d=o.easeShape??wa;e.shapeOriginMs[t]=n-Math.max(0,r)*1e3,i>0?(e.anims[t]={kind:"attack",t0:n,attack:i,release:s,decay:l,hold:m,easeShape:d},e.envelopes[t]=0):m>0?(e.anims[t]={kind:"hold",t0:n,duration:m,release:s,decay:l,easeShape:d},e.envelopes[t]=1):s>0?(e.anims[t]={kind:"release_ease",t0:n,duration:s,easeShape:d},e.envelopes[t]=1):(e.anims[t]={kind:"release_linear",decay:l},e.envelopes[t]=1)}function M3(e,t,n,o){let r=e.anims[t];if(r){if(r.kind==="attack"){let i=(n-r.t0)/1e3,s=r.attack>0?i/r.attack:1,l=Math.max(0,Math.min(1,s));e.envelopes[t]=gp(l),s>=1&&(e.envelopes[t]=1,r.hold>0?e.anims[t]={kind:"hold",t0:n,duration:r.hold,release:r.release,decay:r.decay,easeShape:r.easeShape}:r.release>0?e.anims[t]={kind:"release_ease",t0:n,duration:r.release,easeShape:r.easeShape}:e.anims[t]={kind:"release_linear",decay:r.decay})}else if(r.kind==="hold")e.envelopes[t]=1,(n-r.t0)/1e3>=r.duration&&(r.release>0?e.anims[t]={kind:"release_ease",t0:n,duration:r.release,easeShape:r.easeShape}:e.anims[t]={kind:"release_linear",decay:r.decay});else if(r.kind==="release_ease"){let i=(n-r.t0)/1e3,s=r.duration>0?i/r.duration:1,l=Math.max(0,Math.min(1,s));e.envelopes[t]=Fh(r.easeShape??wa,l),s>=1&&(e.envelopes[t]=0,delete e.anims[t],delete e.shapeOriginMs[t])}else if(r.kind==="release_linear"){let i=e.envelopes[t]||0;e.envelopes[t]=Math.max(0,i-o*r.decay),(e.envelopes[t]||0)<=0&&(e.envelopes[t]=0,delete e.anims[t],delete e.shapeOriginMs[t])}}}function L3(e,t,n,o,r){let i=e.shapeOriginMs[t];if(i==null||!(!!e.anims[t]||(e.envelopes[t]??0)>1e-5))return;let l=ui(o.delay,r.attack,r.hold,r.release,r.decay);return Math.max(0,Math.min(1,(n-i)/1e3/l))}function r2(e,t){let{key:n,bandVal:o,stemHits:r,trigger:i,envelope:s,nowMs:l,dt:m,onFire:d}=t,y=e.prevBands[n]||0,D=i.threshold??Se.triggerThreshold,B=i.count??Se.triggerCount,O=i.delay??Se.delay,K=r>0?r:C3(o,y,D)?1:0;for(let X=0;X<K;X++)e.counts[n]=(e.counts[n]||0)+1,e.counts[n]>=B&&(e.counts[n]=0,O>0?(e.queues[n]||(e.queues[n]=[]),e.queues[n].push(l+O*1e3)):(d?.(n),au(e,n,l,s,O)));if(e.queues[n]?.length)for(;e.queues[n][0]<=l&&(d?.(n),au(e,n,l,s,O),e.queues[n].shift(),!!e.queues[n]?.length););return M3(e,n,l,m),e.prevBands[n]=o,L3(e,n,l,i,s)}u();var a2=120,k3=140,R3=1,iu=[],A3=new Set,E3=new Map([...sr,...jo].map(e=>[e.key,e.label]));function P3(e){let[t,n]=e.split(":"),o=E3.get(t??e)??t??e;return n?`${o} \xB7 ${n}`:o}function i2(){for(let e of A3)e()}function s2(e){let t=e.wallMs??performance.now(),n=Math.max(0,Math.min(1,e.intensity??1)),o=iu[0];if(o&&o.channel===e.channel&&o.fxKey===e.fxKey&&t-o.wallMs<k3){o.repeat+=1,o.intensity=Math.max(o.intensity,n),o.wallMs=t,o.timeSec=e.timeSec,o.beat=e.beat,i2();return}iu.unshift({id:R3++,wallMs:t,timeSec:e.timeSec,beat:e.beat,channel:e.channel,intensity:n,fxKey:e.fxKey,fxLabel:e.fxLabel??(e.fxKey?P3(e.fxKey):void 0),repeat:1}),iu.length>a2&&(iu.length=a2),i2()}var nU=[{key:"all",label:"All"},{key:"kick",label:Cr("kick")},{key:"snare",label:Cr("snare")},{key:"hat",label:Cr("hat")},{key:"low",label:Cr("low")},{key:"mid",label:Cr("mid")},{key:"high",label:Cr("high")},{key:"beat",label:Cr("beat")},{key:"rhythm",label:Cr("rhythm")},{key:"fx",label:Cr("fx")}];u();u();function l2(e,t){let n=Math.max(1,t)/60;return e*n}u();function c2(e,t,n,o){return e&&t&&n.v0 instanceof HTMLVideoElement&&n.v1 instanceof HTMLVideoElement&&o!=null}function Ud(e,t,n,o){if(e&&t.v0&&t.v1)return[t.v0,t.v1];let r=[];return n instanceof HTMLVideoElement&&r.push(n),o instanceof HTMLVideoElement&&o!==n&&r.push(o),r}function Vd(e,t,n){!e||!(t instanceof HTMLVideoElement)||!(n instanceof HTMLVideoElement)||(Wa(e.ctx0,e.c0,t),Wa(e.ctx1,e.c1,n))}function su(e){for(let t of e.frames0)t.close();for(let t of e.frames1)t.close();e.frames0.length=0,e.frames1.length=0}function $d(e){su(e.frames),e.active=!1,e.pendingTrigger=!1,e.phase="forward",e.segmentEnd0=0,e.captureAccum=0,e.capturePending=!1,e.reverseIdx=-1,e.completeAfterReverse=!1}function qd(e){su(e.frames),e.active=!0,e.pendingTrigger=!1,e.phase="forward",e.segmentEnd0=0,e.captureAccum=0,e.capturePending=!1,e.reverseIdx=-1,e.completeAfterReverse=!1}function Wa(e,t,n){let o=Math.max(2,n.videoWidth||2),r=Math.max(2,n.videoHeight||2);(t.width!==o||t.height!==r)&&(t.width=o,t.height=r),e.setTransform(1,0,0,1,0,0),e.clearRect(0,0,t.width,t.height),e.drawImage(n,0,0,t.width,t.height)}function jd(e,t,n){(t.width!==n.width||t.height!==n.height)&&(t.width=n.width,t.height=n.height),e.setTransform(1,0,0,1,0,0),e.clearRect(0,0,t.width,t.height),e.drawImage(n,0,0)}function u2(e,t,n){let o=1/Math.max(12,n);e.captureAccum+=t;let r=e.reverseIdx;for(;e.captureAccum>=o&&r>0;)e.captureAccum-=o,r-=1;return e.captureAccum>=o&&r===0?(e.captureAccum=0,e.reverseIdx=0,e.completeAfterReverse?(e.completeAfterReverse=!1,e.phase="forward",e.active=!1,{finished:!0,frameIdx:0,cycleDone:!0}):(e.phase="replay",{finished:!0,frameIdx:0,cycleDone:!1})):(e.reverseIdx=r,{finished:!1,frameIdx:r,cycleDone:!1})}function p2(e,t,n){let o=e.frames.frames0.length-1;if(o<0)return e.phase="forward",e.active=!1,e.reverseIdx=-1,e.captureAccum=0,e.completeAfterReverse=!1,{finished:!0,frameIdx:-1};let r=1/Math.max(12,n);e.captureAccum+=t;let i=e.reverseIdx;for(;e.captureAccum>=r&&i<o;)e.captureAccum-=r,i+=1;return e.captureAccum>=r&&i>=o?(e.captureAccum=0,e.reverseIdx=o,e.completeAfterReverse=!0,e.phase="reverse",{finished:!0,frameIdx:o}):(e.reverseIdx=i,{finished:!1,frameIdx:i})}async function m2(e,t,n,o){if(!(n.frames0.length>=o))try{let[r,i]=await Promise.all([createImageBitmap(e),createImageBitmap(t)]);n.frames0.push(r),n.frames1.push(i)}catch{}}u();function d2(e){return Math.max(.2,e)}function ua(e){return!!e?.active}u();var F3=jo.filter(e=>e.category==="Color & grade").map(e=>e.key),SU=new Set(F3);var O3=["videoSpeed","boomerang","jumpCut","stutterBack","clipPeek","zap","slowmo","accelerate","playbackCue"],wU=new Set(O3);function f2(e){let{playing:t,force:n=!1,instantLoad:o=!1,loadedPath:r,transitionEnabled:i,boomerangEngaged:s}=e;return t&&!n&&!o&&r!=null&&r.length>0&&i&&!s}function h2(e,t){return e}u();u();var _2=0,Xd=1;function H3(e){let t=e?.sourceMode;return typeof t=="number"&&Number.isFinite(t)&&Math.round(t)===Xd?Xd:_2}function I3(e){return H3(e)===Xd}function B3(e){let t=e?.videoPath;return typeof t=="string"&&t.trim()?t.trim():void 0}function D3(e){let t=e?.videoIndex??1;return typeof t=="number"?t:Math.max(1,Number(t)||1)}function g2(e,t,n){if(e.length===0)return;let o=s=>{if(!s||!hn(s,t))return s;let l=e.findIndex(d=>hn(d.path,s)),m=e[(l+1)%e.length]?.path;return m&&!hn(m,t)?m:s};if(I3(n)){let s=B3(n);if(s){let l=e.find(m=>hn(m.path,s));return o(l?.path??s)}}let r=D3(n),i=Math.max(0,r-1)%e.length;return o(e[i]?.path)}u();u();var b2=4;function lu(e,t=2){let n=e?.eventCount;return typeof n=="number"&&Number.isFinite(n)?Math.max(1,Math.min(b2,Math.round(n))):Math.max(1,Math.min(b2,Math.round(t)))}function Yd(e,t){return`${e}${t}`}function y2(e,t){let n=e?.[Yd("frame",t)];return typeof n=="number"&&Number.isFinite(n)?Math.max(0,Math.round(n)):0}var x2=0,Kd=1;function N3(e){return`clipMode${e}`}function W3(e){return`clipPath${e}`}function G3(e,t){let n=e?.[N3(t)];return typeof n=="number"&&Number.isFinite(n)&&Math.round(n)===Kd?Kd:x2}function z3(e,t){return G3(e,t)===Kd}function U3(e,t){let n=e?.[W3(t)];return typeof n=="string"&&n.trim()?n.trim():void 0}function V3(e,t){let n=e?.[Yd("clip",t)]??t;return typeof n=="number"&&Number.isFinite(n)?Math.max(1,Math.round(n)):Math.max(1,Number(n)||t)}function cu(e,t,n){if(e.length===0)return null;if(z3(t,n)){let i=U3(t,n);if(i)return e.find(l=>hn(l.path,i))?.path??i}let o=V3(t,n),r=Math.max(0,Math.min(e.length-1,o-1));return e[r]?.path??null}u();u();function $3(e){if(!e)return null;try{return new URL(e,window.location.origin).pathname}catch{return null}}function Qd(e,t){if(!t)return!1;let n=e.currentSrc||e.src;if(!n)return!1;let o=$3(n);return o?hn(o,t):!1}function v2(e){return e.readyState>=HTMLMediaElement.HAVE_CURRENT_DATA&&e.videoWidth>0}function S2(e,t){let n=e.duration,o=1/120,r=Math.max(0,t);Number.isFinite(n)&&n>0&&(r=e.loop?(r%n+n)%n:Math.min(r,n-o)),e.currentTime=r}var cr=null;function ef(e){return!!e&&typeof e=="object"&&"currentTime"in e&&Number.isFinite(e.currentTime)}function nl(e){return typeof HTMLVideoElement<"u"&&e instanceof HTMLVideoElement}function Jd(e){let t=e.play?.();t&&typeof t=="object"&&"catch"in t&&t.catch(()=>{})}function w2(e,t){if(nl(e)){S2(e,t);return}let n=e.duration,o=1/120,r=Math.max(0,t);Number.isFinite(n)&&n&&n>0&&(r=e.loop?(r%n+n)%n:Math.min(r,n-o)),e.currentTime=r}function q3(e){let t=ie();for(let n of["s0","s1"]){let o=t[n]?.src;ef(o)&&w2(o,e)}}function uu(e){ie().__hydraPendingPlaybackCueSeek=e}function pu(){let e=ie().__hydraPendingPlaybackCueSeek;return e==null||!Number.isFinite(e)?!1:(delete ie().__hydraPendingPlaybackCueSeek,q3(e),!0)}function Zd(e,t){let n=ie().s2?.src;if(ef(n)){if(nl(n)&&(n.muted=!0,n.loop=!0),w2(n,e),t){n.pause?.();return}Jd(n)}}function j3(e,t,n){let o=ie().s2;if(!o)return;let r=o.src;if(nl(r)&&Qd(r,e)&&v2(r)){Zd(t,n);return}o.initVideo?.(e);let i=o.src,s=typeof HTMLMediaElement<"u"?HTMLMediaElement.HAVE_CURRENT_DATA:2;if(nl(i)&&i.readyState<s){i.addEventListener("loadeddata",()=>Zd(t,n),{once:!0});return}Zd(t,n)}function T2(e){let t=cu(e.library,e.params,1),n=ie().s2?.src;if(t&&nl(n)&&Qd(n,t)){Jd(n);return}t?j3(t,0,!1):ef(n)&&Jd(n)}function mu(){return cr!=null}function C2(){return!!cr?.frozen}function M2(){return cr?.slot??1}function L2(e){if(!cr||(cr.remainingSec-=e,cr.remainingSec>0))return;let t=cr;cr=null,T2(t)}function tf(){if(!cr)return;let e=cr;cr=null,T2(e)}function k2(e,t,n=1){if(e.length===0)return null;let o=typeof t=="string"?t:"",r=e.findIndex(m=>hn(m.path,o)),s=((r>=0?r:0)+n+e.length)%e.length,l=e[s]?.path;return!l||hn(l,o)?null:l}var X3=["playbackCue","layerBlend","videoMap","shatterLayer"];function ol(e){if(!e)return null;for(let t of X3){let n=e[t];if(!(t==="shatterLayer"&&Math.round(Number(n?.params?.mode)||0)<1)&&n?.enabled)return{key:t,config:n}}return null}function R2(e,t,n,o){if(!(!n?.enabled||e.length===0))return o==="playbackCue"?cu(e,n.params,M2())??void 0:g2(e,t,n.params)}u();var lV=cm*1e3,Ga=120,cV=new Float32Array(0),uV=new Float32Array(Ga);function A2(e){let t=typeof window<"u"?window:null;if(!t)return;let n=t.__hydraVideoSpeedRing;(!n||n.capacity!==Ga||!n.times)&&(n={capacity:Ga,times:new Float32Array(Ga),data:new Float32Array(Ga),w:0,len:0},t.__hydraVideoSpeedRing=n);let o=performance.now();n.times[n.w]=o,n.data[n.w]=Number.isFinite(e)?e:1,n.w=(n.w+1)%Ga,n.len<Ga&&n.len++}u();u();function nf(e,t){let n=Math.max(1,Math.round(t)),o=[],r=typeof e.currentVideo=="string"?e.currentVideo:"",i=r,s=e.sceneVideoPaths?.filter(l=>typeof l=="string"&&l.length>0);for(let l=0;l<n;l++){let m=null;if(s&&s.length>0){let d=pm(i,s).next;m=d&&!hn(d,i)?d:null}else{let d=tc(e.filteredLibrary,i)??(i.length>0?i:"");m=k2(e.filteredLibrary,d,1)}if(!m||hn(m,r))break;o.push(m),i=m}return o}function E2(e,t){let n=nf(e,t);return n.length===0?null:n[n.length-1]??null}u();var of=!1,rf=!1,P2=!1;function du(e){of=e}function fu(e){rf=e}function af(){return of}function sf(){return rf}function rl(){return P2}function F2(){return of||rf||P2}function O2(e){typeof window>"u"||!e||(ie().__hydraTransportFallbackLoad=e)}function H2(e){if(typeof window>"u"||!e)return!1;let t=ie(),n=t.__hydraTransportFallbackLoad;return typeof n!="string"||!n||!hn(n,e)?!1:(delete t.__hydraTransportFallbackLoad,!0)}function hu(){typeof window>"u"||(window.__hydraInstantVideoLoad=!0)}function I2(){if(typeof window>"u")return!1;let e=window,t=!!e.__hydraInstantVideoLoad||af()||sf()||rl();return delete e.__hydraInstantVideoLoad,t}var Y3=0;function za(e,t=4e3){Y3=e?performance.now()+t:0}var K3=.05,Q3=2,Z3=1,J3=8;function lf(e){return Math.max(K3,Math.min(Q3,e))}function cf(e){return Math.max(Z3,Math.min(J3,Math.round(e)))}var Jo=null;function eR(){let e=ie();for(let t of["s0","s1"]){let n=e[t]?.src;if(n instanceof HTMLVideoElement&&Number.isFinite(n.currentTime))return n.currentTime}return 0}function B2(e,t){du(!1);let n=ie(),o=n.__hydraClipPeekVideo;if(o?.endPeek(t.returnPath,t.returnTimeSec)){n.__hydraClipPeekSkipLoad=t.returnPath,e.applyVideo(t.returnPath),o.preloadPath(t.peekPath);return}uu(t.returnTimeSec),e.applyVideo(t.returnPath)}function Wi(){return Jo!=null}function D2(){Jo=null,du(!1)}function N2(e,t,n){if(Jo||sf()||rl())return;let o=typeof e.currentVideo=="string"?e.currentVideo:"";if(!o)return;let r=cf(t),i=E2(e,r);if(!i)return;let s=eR(),l=ie(),m=l.__hydraClipPeekVideo,d=lf(n);if(Jo={returnPath:o,returnTimeSec:s,remainingSec:d,peekPath:i},du(!0),m?.beginPeek(i,o,s)){l.__hydraClipPeekSkipLoad=i,e.applyVideo(i);return}O2(i),e.applyVideo(i)}function W2(e,t){if(!Jo||(Jo.remainingSec-=t,Jo.remainingSec>0))return;let n=Jo;Jo=null,B2(e,n)}function uf(e){if(!Jo)return;let t=Jo;Jo=null,B2(e,t)}u();var Io=null,tR=2.5,nR=1,oR=8,rR=1,aR=12;function iR(e){return Math.max(nR,Math.min(oR,Math.round(e)))}function G2(e){return Math.max(rR,Math.min(aR,Math.round(e)))}function pf(){ie().__hydraApplyScene?.()}function sR(){let e=ie();for(let t of["s0","s1"]){let n=e[t]?.src;if(n instanceof HTMLVideoElement&&Number.isFinite(n.currentTime))return n.currentTime}return 0}function lR(e){let t=G2(e);return Math.max(1/24,t/24)}function z2(e,t){let n=t.paths[t.clipIndex];if(!n)return!1;let o=ie(),r=o.__hydraClipPeekVideo,i=r?.showZapClip(n)??"failed";if(i==="ready"){t.waitingLoad=!1,t.waitingLoadSec=0,t.clipRemainingSec=t.frameDurationSec,o.__hydraClipPeekSkipLoad=n,e.applyVideo(n),pf();let s=t.paths[t.clipIndex+1];return s&&r?.preloadPath(s),!0}return i==="loading"?(t.waitingLoad=!0,t.waitingLoadSec=0,t.clipRemainingSec=0,!0):(Io=null,U2(e,t),!1)}function mf(e,t){fu(!1);let n=ie(),o=n.__hydraClipPeekVideo;if(o?.endZap(t.returnPath,t.returnTimeSec)){n.__hydraClipPeekSkipLoad=t.returnPath,e.applyVideo(t.returnPath);let r=t.paths[0];r&&o.preloadPath(r);return}uu(t.returnTimeSec),e.applyVideo(t.returnPath)}function U2(e,t){ie().__hydraClipPeekVideo?.cancelZap?.(),hu(),mf(e,t)}function Gi(){return Io!=null}function V2(){Io=null,fu(!1),ie().__hydraClipPeekVideo?.cancelZap?.()}function $2(e,t,n){if(Io||af()||rl())return;let o=iR(t),r=G2(n),i=typeof e.currentVideo=="string"?e.currentVideo:"";if(!i)return;let s=nf(e,o);if(s.length===0)return;let l=sR(),d=ie().__hydraClipPeekVideo;d?.beginZap(i,l),d?.preloadPath(s[0]??null),Io={returnPath:i,returnTimeSec:l,paths:s,clipIndex:0,clipRemainingSec:0,waitingLoad:!0,waitingLoadSec:0,frameDurationSec:lR(r)},fu(!0),z2(e,Io)||(Io=null)}function q2(e,t){if(!Io)return;let n=Io,o=ie(),r=o.__hydraClipPeekVideo,i=n.paths[n.clipIndex];if(n.waitingLoad&&i){if(n.waitingLoadSec+=t,r?.completeZapClipLoad(i)){n.waitingLoad=!1,n.waitingLoadSec=0,n.clipRemainingSec=n.frameDurationSec,o.__hydraClipPeekSkipLoad=i,e.applyVideo(i),pf();let s=n.paths[n.clipIndex+1];s&&r.preloadPath(s)}else if(n.waitingLoadSec>=tR){let s={...n};Io=null,U2(e,s),pf()}return}if(n.clipRemainingSec-=t,!(n.clipRemainingSec>0)){if(n.clipIndex+=1,n.clipIndex>=n.paths.length){Io=null,mf(e,n);return}n.waitingLoad=!0,n.waitingLoadSec=0,n.clipRemainingSec=0,z2(e,n)}}function df(e){if(!Io)return;let t=Io;Io=null,mf(e,t)}u();function _u(e,t){if(!e||!Number.isFinite(t)||t===0)return;let n=e.duration;if(!Number.isFinite(n)||n<=0){e.currentTime=Math.max(0,e.currentTime+t);return}let o=1/120,r=e.currentTime+t;e.loop?r=(r%n+n)%n:r=Math.min(Math.max(0,r),n-o),e.currentTime=r}function ff(e,t){t>0&&_u(e,t)}function j2(e,t=24){return Math.max(1,Math.round(e))/t}function X2(e,t,n=24){return Math.max(1,Math.round(e))*Math.max(1,Math.round(t))/n}u();function Y2(e){return`${e.t}:${e.orbit}`}function cR(e,t){return`${e}|${t}`}function uR(e){let t=e.indexOf("|");return t===-1?e:e.slice(t+1)}function K2(e,t){return e?.length?e:t??[]}function Q2(e,t,n,o,r){if(!As(e)||!n?.length)return 0;let i=cc(e),s=lc(e),l=0;for(let m of n){if(m.bleed||i!=null&&m.orbit!==i||s!=null&&m.role!==s||m.v<=t)continue;let d=cR(r,Y2(m));o.has(d)||(o.add(d),l+=1)}return l}function Z2(e,t,n){let o=[...t??[],...n??[]];if(!o.length){e.clear();return}let r=new Set(o.filter(i=>!i.bleed).map(i=>Y2(i)));for(let i of e)r.has(uR(i))||e.delete(i)}u();function ur(e){e instanceof HTMLVideoElement&&e.paused&&e.play().catch(()=>{})}function To(e){e instanceof HTMLVideoElement&&!e.paused&&e.pause()}u();u();u();u();var J2=`class HexaOutputKeepaliveProcessor extends AudioWorkletProcessor {
  constructor() {
    super();
    this._n = 0;
  }
...
`;var pR="hexa-open-output";var mR=500,dR=800,fR=2500,hR=8,eS=["analyzer","automix","hydra"],Ua=null,_R=!1,sl=null;var oS=0,tS=0,hf=!1,zi=[],gR="hexa-output-keepalive",kr=null,pa=null,gu=null,il=0,al=0;function gf(e,t){return e&&!t}function Vi(e=Date.now()){return sl&&!sl.closed?!0:e<=oS}function Ui(){return typeof document>"u"||!Vi()?!1:document.hidden||!document.hasFocus()}function rS(e,t){let n=zi.filter(o=>o.id!==e);return n.push({id:e,fn:t}),n.sort((o,r)=>{let i=eS.indexOf(o.id),s=eS.indexOf(r.id);return(i===-1?99:i)-(s===-1?99:s)}),zi.length=0,zi.push(...n),()=>{let o=zi.findIndex(r=>r.id===e);o>=0&&zi.splice(o,1)}}function aS(){oS=Date.now()+fR}function _f(e=!1){if(aS(),!e&&!Ui()||hf)return;let t=performance.now();if(!(t-tS<hR)){tS=t,hf=!0;try{for(let n of zi)n.fn()}finally{hf=!1}}}function bR(){return bf(),_f(!0),!0}function yR(){if(!_R||!Ua||typeof Ua.captureStream!="function")return null;try{return Ua.captureStream(60)}catch{return null}}var xR="data:audio/wav;base64,UklGRigAAABXQVZFZm10IBIAAAABAAEARKwAAIhYAQACABAAAABkYXRhAgAAAAEA";function bf(){if(typeof document>"u")return;if(kr)kr.paused&&kr.play().catch(()=>{});else{let r=document.createElement("audio");r.src=xR,r.loop=!0,r.volume=.001,r.setAttribute("playsinline",""),r.setAttribute("aria-hidden","true"),r.play().catch(()=>{}),kr=r}if(pa){pa.resume().catch(()=>{});return}let e=window.AudioContext||window.webkitAudioContext;if(!e)return;let t=new e,n=t.createOscillator(),o=t.createGain();o.gain.value=1e-4,n.connect(o),o.connect(t.destination),n.start(),t.resume().catch(()=>{}),pa=t,vR(t,o),il||(il=window.setInterval(()=>{Vi()||SR()},2e3))}async function vR(e,t){let n=al,o=e.createGain();if(o.gain.value=0,e.audioWorklet){let i=URL.createObjectURL(new Blob([J2],{type:"application/javascript"}));try{if(await e.audioWorklet.addModule(i),n!==al||pa!==e)return;let s=new AudioWorkletNode(e,gR);s.port.addEventListener("message",()=>{Ui()&&_f()}),o.connect(s),s.connect(t),gu=s;return}catch{if(n!==al||pa!==e)return}finally{URL.revokeObjectURL(i)}}if(n!==al||pa!==e)return;let r=e.createScriptProcessor(512,1,1);r.onaudioprocess=()=>{Ui()&&_f()},o.connect(r),r.connect(t),gu=r}function SR(){al+=1,il&&(window.clearInterval(il),il=0),gu?.disconnect(),gu=null,pa?.close().catch(()=>{}),pa=null,kr&&(kr.pause(),kr.src="",kr=null)}var wR=`<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="utf-8"/>
...
function checkInterrupt() {
  if (!lastPulse) return;
  if (!openerLive() || performance.now() - lastPulse > ${mR}) veil.classList.remove("live");
}
...
</html>`;function TR(){let e=window;e.__hydraOpenOutput=iS,e.__hexaPumpFromOutput=bR,e.__hexaCaptureStream=yR,e.__hydraOutputDebug=()=>({src:Ua?{id:Ua.id,w:Ua.width,h:Ua.height}:null,win:!!(sl&&!sl.closed),keepalive:!!(kr&&!kr.paused)})}var nS;function CR(e){let t=window.__hexaOutputPlacement,n=e??nS??t;return e&&(nS=e),n}function iS(e){let t=CR(e),n=["popup=yes","toolbar=no","menubar=no","location=no","status=no","scrollbars=no"];t&&(Number.isFinite(t.left)&&n.push(`left=${Math.round(t.left)}`),Number.isFinite(t.top)&&n.push(`top=${Math.round(t.top)}`),Number.isFinite(t.width)&&n.push(`width=${Math.round(t.width)}`),Number.isFinite(t.height)&&n.push(`height=${Math.round(t.height)}`));let o=window.open("about:blank","hexa-output",n.join(","));if(!o)return console.warn("Output window was blocked. Press D in the live session."),null;sl=o,aS(),TR(),bf();try{o.document.open(),o.document.write(wR),o.document.close()}catch(r){console.warn("Could not write output player document",r)}if(t&&Number.isFinite(t.left)&&Number.isFinite(t.top))try{o.moveTo(Math.round(t.left),Math.round(t.top)),Number.isFinite(t.width)&&Number.isFinite(t.height)&&o.resizeTo(Math.round(t.width),Math.round(t.height))}catch{}return o}typeof window<"u"&&(window.addEventListener(pR,()=>{iS()}),document.addEventListener("visibilitychange",()=>{document.hidden&&Vi()&&bf()}));var $i=(e,t,n)=>{if(!(e instanceof HTMLVideoElement)||(e.paused||e.pause(),t<=0))return;let o=e.currentTime+t*n;e.duration&&(o<0?o=e.loop?e.duration+o%e.duration:0:o>=e.duration&&(o=e.loop?o%e.duration:e.duration)),e.currentTime=o},sS=(e,t)=>Zt(e,t,"playbackSpeed",1.25,ie().customBands);function lS(e){let{settingsRef:t,studioModeRef:n,bpmRef:o,hydraRef:r,hydraRenderBudgetKeyRef:i,syncHydraRenderBudgetRef:s,runHydraTickRef:l,hydraResizePauseRef:m,hydraResizeResumeRef:d,syncElectricNoiseTriggerTexRef:y,transitionStateRef:D,pendingVideoLoadRef:B,activeChannelRef:O,clipLoadFreezeRef:K,clipPeekDepsRef:X,onPlaybackCueRef:pe,boomerangBridgeReadyRef:Re,boomerangBackingRef:ge,boomerangCanvasBundleRef:Fe,boomerangStateRef:Qe,boomerangCaptureFpsCapRef:Ze,boomerangMaxFramesCapRef:dt,currentSpeedSmoothedRef:Et,fxReactiveTriggerGateRef:at,reactiveTriggerDescriptorsRef:nt,electricNoiseCirclesRef:ft,electricNoiseCirclePackRef:A,neonGridBundleRef:M,neonGridBridgeReadyRef:k,neonGridRuntimeRef:p,s3OverlayBindRef:re,throughTheStarsBundleRef:we,throughTheStarsBridgeReadyRef:Ye,lumaDustBundleRef:Ue,lumaDustBridgeReadyRef:Ne,lumaLockBundleRef:qe,lumaLockBridgeReadyRef:Je,textLayerBundleRef:Ht,textLayerBridgeReadyRef:et,textLayerRuntimeRef:Dt,oscilloscopeBundleRef:gt,oscilloscopeBridgeReadyRef:bt,metalEnvBundleRef:Pt,metalEnvBridgeReadyRef:vt,perfLastPrimaryRef:zt,perfVideoSinkRef:tn,perfPresentationLastRef:$t,perfPresentationSinkRef:bn,wasStudioFrozenRef:vn,flushPendingVideoLoad:mo,getParamValue:Ft,resolvePrimaryVideoSpeed:on,resolveStarLayerPixels:zn,isTransportFrozen:lt,isStudioTransportRunning:Pn,isVisualTransportPlaying:Mt,bootstrapTransportFreeze:h,reportPresentationMode:Fn}=e,Zn=(Ie,it)=>{let We=ie(),ke=We.hydraSettings??{},St=ko(ke,"neonGrid"),en=St?.config,pt=M.current;en&&k.current&&pt&&Qv({bundle:pt,s3:co("neonGrid"),bindState:re.current,params:en.params,spawn:Ks(en.params),draw:Kc(en.params),dt:Ie,now:it,aspect:window.innerWidth/Math.max(1,window.innerHeight),envelope:We.hydraEnvelopes?.[St.effectKey]??0,binding:Nn(en,"base"),bands:We.customBands,runtime:p.current});let At=We.hydraSettings?.fx?.gridShuffle;At?.enabled&&l1({envelope:We.hydraEnvelopes?.gridShuffle??0,binding:Nn(At,"base"),bands:We.customBands,dt:Ie});let wt=ko(ke,"throughTheStars"),pn=wt?.config,eo=we.current;if(pn&&Ye.current&&eo){let Co=zn();dv({bundle:eo,s3:co("throughTheStars"),bindState:re.current,fxCfg:pn,bands:We.customBands,amount:_n(wt.effectKey,pn,We.customBands,Xn),dt:Ie,now:it,aspect:window.innerWidth/Math.max(1,window.innerHeight),pixelWidth:Co.width,pixelHeight:Co.height})}let fo=ko(ke,"lumaDust"),yo=fo?.config,_t=Ue.current;if(yo&&Ne.current&&_t){let Co=zn(),or=O.current===0?We.s0?.src:We.s1?.src;Nv({bundle:_t,s3:co("lumaDust"),bindState:re.current,video:or,params:yo.params,amount:_n(fo.effectKey,yo,We.customBands,Xn),dt:Ie,now:it,aspect:window.innerWidth/Math.max(1,window.innerHeight),pixelWidth:Co.width,pixelHeight:Co.height,skipVideoSample:K.current})}let Ct=ko(ke,"lumaLock"),Xt=Ct?.config,Ut=qe.current;if(Xt&&Je.current&&Ut){let Co=zn(),or=O.current===0?We.s0?.src:We.s1?.src;$v({bundle:Ut,s3:co("lumaLock"),bindState:re.current,video:or,params:Xt.params,amount:_n(Ct.effectKey,Xt,We.customBands,Xn),dt:Ie,now:it,skipVideoSample:K.current,pixelWidth:Co.width,pixelHeight:Co.height})}let mn=ko(ke,"textLayer"),Er=mn?.config,sn=Ht.current;Er&&et.current&&sn&&iv({bundle:sn,s3:co("textLayer"),bindState:re.current,fxCfg:Er,bands:We.customBands,amount:_n(mn.effectKey,Er,We.customBands,Xn),now:it,envelope:We.hydraEnvelopes?.[mn.effectKey]??0,binding:Nn(Er,"base"),runtime:Dt.current,shouldBind:!0})},Sn=0,On=0,Hn=performance.now(),Qt=Et.current,rn=0,wn=0,an=0,Tn=(Ie=!1)=>{let it=r.current;if(!it?.synth)return;let We=lt(),ke=Mt(),St=!We&&(Ie||at.current),en=gf(document.hidden,Vi()),pt=`${en?"h":"v"}-${We?"f":ke?"p":"s"}-${St?"r":"i"}`;if(i.current!==pt){if(i.current=pt,en){tl(it.synth,0),it.synth.fps=2;return}if(We){tl(it.synth,0),it.synth.fps=void 0;return}if(!ke){tl(it.synth,0),it.synth.fps=St?30:4;return}tl(it.synth,1),it.synth.fps=void 0}};s.current=Tn;let Mn=()=>{i.current="",Tn(),Ui()||Jn(0)},xn=()=>{Sn&&cancelAnimationFrame(Sn),On&&clearTimeout(On),Sn=0,On=0};m.current=()=>xn(),y.current=()=>{let Ie=performance.now();ft.current.length>0?A.current=ty(ft.current,Ie):A.current={count:0,slots:[]},oy(A.current.slots)};let Jn=Ie=>{if(!(Fo()&&(Jl(),Fo()))){if(xn(),Ui()){On=window.setTimeout(()=>{On=0,F(performance.now())},50);return}if(Ie>0){On=window.setTimeout(()=>{On=0,Sn=requestAnimationFrame(F)},Ie);return}Sn=requestAnimationFrame(F)}};d.current=()=>Jn(0),document.addEventListener("visibilitychange",Mn),window.addEventListener("focus",Mn);let Go=Ie=>{zt.current!==Ie&&(zt.current=Ie,tn.current?.(Ie))},no=t2(),er={},oo={},Vr=(Ie,it=!0)=>{if(n2(no),Ie.hydraEnvelopes={},Ie.hydraEnvelopePhaseU={},Ie.hydraTriggerCounts={},Ie.vibrationAmp=0,wn=0,Ie.degaussAmp=0,an=0,Wi()){let We=X.current;We?uf(We):D2()}if(Gi()){let We=X.current;We?df(We):V2()}mu()&&tf(),it&&(ft.current=Rc(),A.current={count:0,slots:[]})},Rr=Ie=>c2(!!Ie?.fx?.boomerang?.enabled,Re.current,ge.current,Fe.current),Ar=Ie=>{if(!Mt()||K.current)return;let it=ie(),We=it.hydraSettings,ke=Rr(We),St=ke&&ua(Qe.current);if(!h2(St,Ie)){if(Ie==="boomerang"){if(!We?.fx?.boomerang?.enabled)return;let pt=Qe.current;if(ua(pt))return;if(!ke){pt.pendingTrigger=!0;return}qd(pt);return}if(Ie==="jumpCut"){if(!We?.fx?.jumpCut?.enabled)return;let pt=X2(Ft("jumpCut","skipFrames",2),Ft("jumpCut","jumpCuts",1));for(let At of Ud(ke,ge.current,it.s0?.src,it.s1?.src))ff(At,pt);ke&&Vd(Fe.current,ge.current.v0,ge.current.v1),it.s2?.src instanceof HTMLVideoElement&&ff(it.s2.src,pt);return}if(Ie==="stutterBack"){if(!We?.fx?.stutterBack?.enabled)return;let pt=Ft("stutterBack","backFrames",6),At=j2(pt);for(let pn of Ud(ke,ge.current,it.s0?.src,it.s1?.src))_u(pn,-At);ke&&Vd(Fe.current,ge.current.v0,ge.current.v1);let wt=it.s2?.src;wt instanceof HTMLVideoElement&&_u(wt,-At);return}if(Ie==="clipPeek"){let en=We?.fx?.clipPeek,pt=X.current;if(!en?.enabled||!pt||Wi()||Gi())return;let At=lf(Ft("clipPeek","holdSec",.35)),wt=cf(Ft("clipPeek","steps",1));N2(pt,wt,At);return}if(Ie==="zap"){let en=We?.fx?.zap,pt=X.current;if(!en?.enabled||!pt||Wi()||Gi())return;let At=Math.max(1,Math.min(8,Math.round(Ft("zap","clipCount",3)))),wt=Math.max(1,Math.min(12,Math.round(Ft("zap","framesPerClip",4))));$2(pt,At,wt)}}},bo=(Ie,it)=>{let ke=ie().triggerDebugStudio?.playbackSec??it/1e3,St=Math.max(30,o.current);if(s2({timeSec:ke,beat:l2(ke,St),channel:"fx",fxKey:Ie,intensity:1}),Ie==="clipPeek"||Ie==="zap"||Ie==="jumpCut"||Ie==="stutterBack"||Ie==="boomerang"){Ar(Ie);return}if(Tb(Ie,ie().hydraSettings??{})==="neonGrid"){let pt=M.current,At=ko(ie().hydraSettings??{},"neonGrid");pt&&At&&Ii(pt,Ks(At.config.params))}if(Ie.startsWith("playbackCue:frame")){let pt=Number.parseInt(Ie.slice(17),10),At=ie().hydraSettings?.fx?.playbackCue;if(!At?.enabled||!Number.isFinite(pt)||pt<1||pt>4)return;let wt=At.params??{},pn=lu(wt);if(pt>pn)return;let eo=y2(wt,pt);pe.current?.(pt,eo,Math.max(.05,Ft("playbackCue","holdSec",.35)),wt)}},$r=Ie=>Ie==="slowmo"?Um(Ft("slowmo","duration",Mi)):Ie==="accelerate"?Gm(Ft("accelerate","duration",Ci)):null,tr=(Ie,it)=>{if(Ie==="slowmo"){let We=Ft("slowmo","duration",Mi);ie().slowmoPulseUntilMs=it+pb(We)*1e3}else if(Ie==="accelerate"){let We=Ft("accelerate","duration",Ci);ie().acceleratePulseUntilMs=it+lb(We)*1e3}},un=Ie=>{if(!ci(Ie))return;let it=performance.now(),ke=ie().hydraSettings?.fx?.[Ie];if(!ke?.enabled)return;let St=Nn(ke,"base"),en=$r(Ie),pt=en??km(St,wi(ie().hydraModulation?.config)),At=St.trigger?.delay??0;au(no,Ie,it,pt,At),bo(Ie,it),en&&tr(Ie,it)},zo=Ie=>{ey(ft.current,Ie)};ie().__hydraFireFxTrigger=un;let nr=(Ie,it,We,ke,St)=>{let en=Ie.paramKey??"base",pt=Nn(it,en);if(!jn(pt)||pt.source==="none")return;let At=Ie.key,wt=ie(),pn=Mr(pt.source,wt.customBands,pt.depth),eo=As(pt.source)?Q2(pt.source,pt.trigger.threshold,K2(wt.studioStemEventsStep,wt.studioEventPulses),no.stemHitsSeen,At):0,fo=$r(Ie.fxKey),yo=fo??km(pt,wi(ie().hydraModulation?.config)),_t=r2(no,{key:At,bandVal:pn,stemHits:eo,trigger:pt.trigger,envelope:yo,nowMs:We,dt:ke,onFire:Ct=>{bo(Ct,We),fo&&tr(Ie.fxKey,We),Ie.fxKey==="electricNoise"&&!Ie.paramKey&&zo(We)}});if(_t!=null&&(St[At]=_t),pt.envelopeRef&&pt.mode==="envelope"){let Ct=parseInt(pt.envelopeRef.slice(3),10),Xt=no.envelopes[At]??0,Ut=er[Ct]??0;Xt>Ut&&(er[Ct]=Xt,oo[Ct]=_t??0)}},pr=Math.max(.04,1/24),Yn=(Ie,it)=>{Ie.loop&&typeof Ie.duration=="number"&&Number.isFinite(Ie.duration)&&Ie.duration>0&&(Ie.ended||Ie.currentTime>=Ie.duration-pr)&&(Ie.currentTime=0,it&&Ie.play().catch(()=>{}))},mr=(Ie,it,We)=>{Ie instanceof HTMLVideoElement&&(We?Ie.paused&&Ie.play().catch(()=>{}):Ie.paused||Ie.pause(),Ie.playbackRate=it,Yn(Ie,We))},Uo=Ie=>{let it=ie(),We=it.s2?.src;if(!(We instanceof HTMLVideoElement))return;if(C2()){We.paused||We.pause();return}Ie&&We.paused&&We.play().catch(()=>{});let ke=ol(it.hydraSettings?.fx);We.playbackRate=ke?sS(ke.key,ke.config):1,Yn(We,Ie)},F=Ie=>{if(Fo())return;!D.current.active&&B.current&&mo();let it=Math.min((Ie-Hn)/1e3,.1);Hn=Ie;let We=lt(),ke=t.current.isVideoPlaying===!1&&!Pn(),St=We||ke,en=X.current;!St&&en&&(Wi()?W2(en,it):Gi()?q2(en,it):mu()&&L2(it)),St||Zn(it,Ie);let{s0:pt,s1:At,hydraSettings:wt,customBands:pn}=ie(),eo=o2(no)||ft.current.length>0;if(gf(document.hidden,Vi())){Tn(eo),Jn(500);return}if(We&&vn.current===!1)r.current&&(h(),vn.current=!0);else if(vn.current&&!We){i.current="",Tn(eo),l.current(16.67);let g=ie();ur(g.s0?.src),ur(g.s1?.src),ur(g.s2?.src),ur(ge.current?.v0),ur(ge.current?.v1),vn.current=!1}else We||(vn.current=!1);if(St){let g=ie();if(To(g.s2?.src),To(g.s0?.src),To(g.s1?.src),To(ge.current?.v0),To(ge.current?.v1),We?Vr(g,!1):ko(wt??{},"neonGrid")||(g.hydraEnvelopes={},g.hydraEnvelopePhaseU={},g.hydraTriggerCounts={},g.slowmoTrailMix=0),!n.current){g.customBands={kick:0,snare:0,hat:0,bass:0,vocals:0,low:0,mid:0,high:0,beat:0,rhythm:0,specFast:0,specSlow:0,master:0},ie().masterLevel=0,ie().masterDbfs=-96,i.current="",Tn(!1),Jn(250);return}}Tn(!1);let fo=ie().hydraSettings,yo=Re.current&&fo?.fx?.boomerang?.enabled;if(pt&&At&&!yo){let g=O.current===0?pt:At;g.src instanceof HTMLVideoElement&&(g.src.loop=!0)}else if(pt&&At&&yo){let g=ge.current.v0,Pe=ge.current.v1;g&&(g.loop=!0),Pe&&(Pe.loop=!0)}let _t=eo;if(!!wt?.fx&&(at.current||_t)){let g=ie();g.studioStemHitsReset&&(no.stemHitsSeen.clear(),g.studioStemHitsReset=!1);let Pe=nt.current,T={},I=wt.fx;for(let q of Object.keys(er))delete er[Number(q)];for(let q of Object.keys(oo))delete oo[Number(q)];for(let q=0;q<Pe.length;q++){let te=Pe[q],se=te.config??I[te.fxKey];!se||!se.enabled||nr(te,se,Ie,it,T)}Z2(no.stemHitsSeen,g.studioStemEventsStep,g.studioEventPulses),ie().hydraEnvelopes=no.envelopes,ie().hydraEnvelopePhaseU=T,ie().hydraTriggerCounts=no.counts;let W=ie();W.hydraModulation&&(W.hydraModulation.eg={...er},W.hydraModulation.egOneShotPhase={...oo})}else wt?.fx&&(ie().hydraEnvelopes={},ie().hydraEnvelopePhaseU={},ie().hydraTriggerCounts={});if(wt){let g=pn??{kick:0,snare:0,hat:0,bass:0,vocals:0,low:0,mid:0,high:0,beat:0,rhythm:0,specFast:0,specSlow:0,master:0};y.current(),ie().low=g.low||0,ie().mid=g.mid||0,ie().high=g.high||0,ie().beat=g.beat||0,typeof g.kick=="number"&&(ie().kick=g.kick),ie().masterLevel=typeof g.master=="number"?g.master:ie().masterLevel??0;let Pe=wt.fx?.vibration;if(Pe?.enabled){let I=Jy(Pe,no.envelopes.vibration??0,q=>So("vibration",q,g)),W=Ky(Pe,I);wn=Qy(wn,W,Pe),ie().vibrationAmp=wn}else wn*=.88,ie().vibrationAmp=wn;let T=wt.fx?.degauss;if(T?.enabled){let I=Xy(T,no.envelopes.degauss??0,q=>So("degauss",q,g)),W=$y(T,I);an=qy(an,W,T),ie().degaussAmp=an}else an*=.86,ie().degaussAmp=an}if(!wt||!pt||!At){Go(null),Fn("idle"),Jn(250);return}let Xt=!!wt.fx?.boomerang?.enabled&&Re.current&&!!ge.current.v0&&!!ge.current.v1&&!!Fe.current;if(!Xt&&ua(Qe.current)&&$d(Qe.current),!Xt&&!(pt.src instanceof HTMLVideoElement&&At.src instanceof HTMLVideoElement)){Go(null),Fn("idle"),Jn(250);return}let Ut=Xt?ge.current.v0:pt.src,mn=Xt?ge.current.v1:At.src;Go(Ut);let Er=on(Ut.duration);Qt=hb(Er,Qt,_b(wt.fx)),Et.current=Qt,(rn++&7)===0&&A2(Qt);let sn=Mt()&&!K.current,Co=wt.fx?.clipPeek,or=X.current;!Co?.enabled&&Wi()&&or&&uf(or);let Va=wt.fx?.zap,ma=X.current;!Va?.enabled&&Gi()&&ma&&df(ma),!wt.fx?.playbackCue?.enabled&&mu()&&tf();let Un=Fe.current,dr=wt.fx?.boomerang,fr=Qe.current;Xt&&dr?.enabled&&fr.pendingTrigger&&!ua(fr)&&qd(fr);let Ro=Xt&&!!dr?.enabled&&ua(fr);if(Xt&&dr?.enabled&&Un&&sn&&!Ro){let g=Qe.current;(g.phase!=="forward"||g.frames.frames0.length>0||g.segmentEnd0>0||g.capturePending||g.completeAfterReverse)&&$d(g),Qt>=sa?(mr(Ut,Qt,sn),mr(mn,Qt,sn)):($i(Ut,Qt,it),$i(mn,Qt,it)),Wa(Un.ctx0,Un.c0,Ut),Wa(Un.ctx1,Un.c1,mn),Uo(sn)}else if(Ro&&dr?.enabled&&Un&&sn){let g=Qe.current,Pe=d2(Ft("boomerang","segmentSec",1.25)),T=Math.max(24,Math.min(180,Math.round(Ft("boomerang","maxFrames",60)),dt.current)),I=Math.max(12,Math.min(60,Ft("boomerang","captureFps",24),Ze.current)),W=()=>{Ut.currentTime=g.segmentStart0,mn.currentTime=g.segmentStart1,su(g.frames),g.active=!1,g.phase="forward",g.segmentEnd0=0,g.reverseIdx=-1,g.captureAccum=0,g.completeAfterReverse=!1};if(g.phase==="reverse"||g.phase==="replay"){Ut.pause(),mn.pause();let q=g.reverseIdx,te=q>=0?g.frames.frames0[q]:null,se=q>=0?g.frames.frames1[q]:null;if(q>=0&&te&&se)if(jd(Un.ctx0,Un.c0,te),jd(Un.ctx1,Un.c1,se),g.phase==="reverse"){let{cycleDone:_e}=u2(g,it,I);_e&&W()}else p2(g,it,I);else W()}else{if(!Number.isFinite(g.segmentEnd0)||g.segmentEnd0<=g.segmentStart0+1e-4){g.segmentStart0=Ut.currentTime,g.segmentStart1=mn.currentTime;let te=Ut.duration,se=g.segmentStart0+Pe;Number.isFinite(te)&&te>0&&(se=Math.min(se,te-1/120)),g.segmentEnd0=Math.max(g.segmentStart0+.05,se)}if(sn&&Qt>=sa){Ut.paused&&Ut.play().catch(()=>{}),mn.paused&&mn.play().catch(()=>{}),Ut.playbackRate=Qt,mn.playbackRate=Qt;let te=ie().s2;if(te&&te.src instanceof HTMLVideoElement){te.src.paused&&te.src.play().catch(()=>{});let se=ol(wt.fx);se?te.src.playbackRate=sS(se.key,se.config):te.src.playbackRate=1}Yn(Ut,sn),Yn(mn,sn)}else sn?(Ut.paused||Ut.pause(),mn.paused||mn.pause(),$i(Ut,Qt,it),$i(mn,Qt,it)):(Ut.paused||Ut.pause(),mn.paused||mn.pause());Wa(Un.ctx0,Un.c0,Ut),Wa(Un.ctx1,Un.c1,mn);let q=Math.max(.03,1/I);if(Ut.currentTime>=g.segmentEnd0-q)g.frames.frames0.length>=2?(g.phase="reverse",g.completeAfterReverse=!1,Ut.pause(),mn.pause(),g.reverseIdx=g.frames.frames0.length-1,g.captureAccum=0):W();else{g.captureAccum+=it;let te=1/I;g.captureAccum>=te&&!g.capturePending&&g.frames.frames0.length<T&&(g.captureAccum-=te,g.capturePending=!0,m2(Ut,mn,g.frames,T).finally(()=>{g.capturePending=!1}))}}Uo(sn)}else if(sn&&Qt>=sa&&!document.hidden){let g=ie();mr(g.s0?.src,Qt,sn),mr(g.s1?.src,Qt,sn),Uo(sn)}else if(sn){let g=ie();$i(g.s0?.src,Qt,it),$i(g.s1?.src,Qt,it),Uo(sn)}else{let g=ie();To(g.s0?.src),To(g.s1?.src),Uo(!1)}let qr="decoder";if(Ro&&dr?.enabled&&Un&&sn){let g=Qe.current;(g.phase==="reverse"||g.phase==="replay"||Qt<sa)&&(qr="manualSeek")}else Qt<sa&&(qr="manualSeek");Fn(qr);let hr=ko(wt,"oscilloscope"),Ao=hr?.config;if(!!Ao&&bt.current&&gt.current){let g=ie(),Pe=gt.current;ho(co("oscilloscope"),Pe.canvas,"oscilloscope",re.current);let T=g.studioOscilloscopePeaks,I=g.studioOscilloscopeDurationSec??0,W=g.studioOscilloscopeTimeSec??0;if(n.current&&T&&T.length>0&&I>0&&(g.studioTransportActive||W>0))Jx(Pe,T,I,W);else{let _e=g.oscilloscopeLiveRef?.current?.spectrum,ze=0;if(_e&&_e.length>8){let Ke=Math.max(1,Math.floor(_e.length/64));for(let st=0;st<_e.length;st+=Ke)ze+=_e[st]}ze<64&&ev(Pe,g.customBands??{},performance.now()*.003)}let q=Zx(Ao.params),te=(se,_e)=>Zt(hr.effectKey,Ao,se,_e,ie().customBands,"oscilloscope");tv(co("oscilloscope"),Pe,{persistence:te("persistence",.72),positionY:te("positionY",.88),scale:te("scale",.55),mode:Math.round(te("mode",0)),colorLo:q.colorLo,colorMid:q.colorMid,colorHi:q.colorHi},performance.now())}let _r=wt.fx?.metalSphere;_r?.enabled&&(_r.base??0)>.01&&!jv(Number(_r.params?.envMap??0))&&vt.current&&Pt.current&&Yv(ie().s3,Ut,Pt.current,{now:performance.now(),videoPath:t.current.video??""}),Jn(0)},Bo=rS("hydra",()=>{F(performance.now())});return Jn(0),Tn(),()=>{Bo(),document.removeEventListener("visibilitychange",Mn),window.removeEventListener("focus",Mn),delete ie().__hydraFireFxTrigger,s.current=()=>{},m.current=null,d.current=null,y.current=()=>{},xn(),Go(null),$t.current=null,bn.current?.("idle")}}u();function cS(e){let{settingsRef:t,activeChannelRef:n,transitionStateRef:o,pendingVideoLoadRef:r,currentVideoRef:i,videoLoadSeqRef:s,clipLoadFreezeRef:l,secondaryVideoRef:m,boomerangBridgeReadyRef:d,boomerangBackingRef:y,boomerangStateRef:D,syncPlaybackRef:B,applySceneAndRenderRef:O,bumpLumaDustReset:K,teardownBoomerangBridge:X,isPrimaryPlaybackActive:pe}=e,Re=()=>{if(!o.current.active)return;let{s0:Qe,s1:Ze}=ie();if(!Qe||!Ze)return;let dt=performance.now()-o.current.startTime,Et=Math.max(1,o.current.duration),at=Math.min(1,dt/Et),nt=n.current===0?1:0;at>=.5&&(n.current=nt),o.current.active=!1;let ft=pe(),A=n.current===0?Ze:Qe,M=n.current===0?Qe:Ze;To(A.src),ft&&ur(M.src)},ge=()=>{let Qe=r.current;!Qe||o.current.active||(r.current=null,!hn(Qe,i.current??"")&&Fe(!1))},Fe=Qe=>{let Ze=!1,dt=t.current,{s0:Et,s1:at}=ie();if(!Et||!at||!dt.video)return()=>{Ze=!0};let nt=()=>{if(d.current||!(Et.src instanceof HTMLVideoElement)||!(at.src instanceof HTMLVideoElement)){X({reloadPath:dt.video,restoreBacking:!1});return}d.current=!1,y.current={v0:null,v1:null}},ft=ie().__hydraClipPeekSkipLoad;if(ft&&hn(ft,dt.video)){delete ie().__hydraClipPeekSkipLoad,delete ie().__hydraInstantVideoLoad,i.current=dt.video,B.current(),O.current();let gt=m.current,{s2:bt}=ie();return bt&&gt&&bt.initVideo(gt),()=>{Ze=!0}}let A=H2(dt.video);if(F2()&&!A)return o.current.active=!1,r.current=null,delete ie().__hydraInstantVideoLoad,i.current=dt.video,B.current(),O.current(),()=>{Ze=!0};let M=i.current,k=M===null||!M||!hn(M,dt.video);if(!Qe&&!k)return B.current(),O.current(),()=>{Ze=!0};K(),(Qe||r.current&&hn(r.current,dt.video))&&(r.current=null);let p=pe(),re=I2();re&&(o.current.active=!1,r.current=null,l.current=!1),Qe&&(l.current=!1);let we=dt.fx?.transition,Ye=f2({playing:p,force:Qe,instantLoad:re,loadedPath:M,transitionEnabled:!!we?.enabled,boomerangEngaged:ua(D.current)});if(Ye&&o.current.active)return r.current=dt.video,()=>{Ze=!0};let Ue=++s.current,Ne=Ye,qe=Qe||re||k&&M!=null&&!!M&&!Ne,Je=()=>{let gt=m.current,{s2:bt}=ie();if(!bt||!gt)return;bt.initVideo(gt);let Pt=()=>{let zt=bt.src;if(zt instanceof HTMLVideoElement)if(zt.muted=!0,zt.loop=!0,p)zt.play().catch(()=>{});else{try{zt.currentTime=0}catch{}zt.pause()}},vt=bt.src;vt instanceof HTMLVideoElement&&vt.readyState>=2?Pt():vt instanceof HTMLVideoElement?vt.addEventListener("loadeddata",Pt,{once:!0}):setTimeout(Pt,500)};if(qe){o.current.active=!1,nt();let gt=n.current===0?Et:at,bt=n.current===0?at:Et,Pt=!1;za(!0);let vt=()=>{if(Pt||(Pt=!0,Ze||s.current!==Ue))return;let $t=bt.src;if(!($t instanceof HTMLVideoElement)){l.current=!1,za(!1);return}if($t.muted=!0,$t.loop=!0,pe())$t.play().catch(()=>{});else{try{$t.currentTime=0}catch{}$t.pause()}n.current=n.current===0?1:0;let bn=gt.src;bn instanceof HTMLVideoElement&&bn!==$t&&bn.pause(),i.current=dt.video,pu(),B.current(),Je(),l.current=!1,za(!1),O.current()},zt=()=>{if(Ze||s.current!==Ue||Pt)return;let $t=bt.src;if(!($t instanceof HTMLVideoElement)){requestAnimationFrame(zt);return}if($t.readyState>=HTMLMediaElement.HAVE_CURRENT_DATA)vt();else{let bn=()=>vt();$t.addEventListener("loadeddata",bn,{once:!0}),$t.addEventListener("canplay",bn,{once:!0})}};bt.initVideo(dt.video),zt();let tn=window.setTimeout(()=>{if(Ze||s.current!==Ue||Pt)return;Pt=!0,l.current=!0,To(Et.src),To(at.src),Et.initVideo(dt.video),at.initVideo(dt.video),i.current=dt.video,n.current=0;let $t=()=>{if(Ze||s.current!==Ue)return;let vn=Et.src,mo=at.src;if(!(vn instanceof HTMLVideoElement)||!(mo instanceof HTMLVideoElement)){l.current=!1,za(!1);return}for(let Ft of[vn,mo])Ft.muted=!0,Ft.loop=!0,pe()?Ft.play().catch(()=>{}):Ft.pause();B.current(),Je(),l.current=!1,za(!1),O.current()},bn=()=>{if(Ze||s.current!==Ue)return;let vn=Et.src,mo=at.src;if(!(vn instanceof HTMLVideoElement)||!(mo instanceof HTMLVideoElement)){requestAnimationFrame(bn);return}$t()};bn()},3e3);return()=>{Ze=!0,window.clearTimeout(tn),l.current=!1,za(!1)}}if(Ne){o.current.active&&Re(),nt();let gt=n.current===0?Et:at,bt=n.current===0?at:Et,Pt=gt.src,vt=Pt instanceof HTMLVideoElement&&Number.isFinite(Pt.currentTime)?Pt.currentTime:0,zt=Math.max(.05,Zt("transition",we,"duration",1,ie().customBands)),tn=()=>{if(Ze||s.current!==Ue)return;let Ft=bt.src;if(!(Ft instanceof HTMLVideoElement))return;Ft.muted=!0,Ft.loop=!0;let on=!1,zn=()=>{if(on||(on=!0,Ze||s.current!==Ue))return;if(l.current=!1,p){Ft.play().catch(()=>{});let Mt=gt.src;Mt instanceof HTMLVideoElement&&Mt.paused&&Mt.play().catch(()=>{})}else Ft.pause();B.current();let Pn=Rh(Number(we.params?.type??0));o.current={active:!0,startTime:performance.now(),duration:zt*1e3,resolvedType:Pn},Je(),O.current()},lt=()=>{if(pu()||!Number.isFinite(vt)||vt<0)return;let Pn=Ft.duration;Number.isFinite(Pn)&&Pn>0?Ft.currentTime=vt%Pn:Ft.currentTime=vt};Ft.readyState>=HTMLMediaElement.HAVE_METADATA?lt():Ft.addEventListener("loadedmetadata",lt,{once:!0}),Ft.readyState>=HTMLMediaElement.HAVE_CURRENT_DATA?zn():(Ft.addEventListener("loadeddata",zn,{once:!0}),Ft.addEventListener("canplay",zn,{once:!0}))},$t=!1,bn=()=>{$t||($t=!0,tn())},vn=()=>{if(Ze||s.current!==Ue)return;if(!(bt.src instanceof HTMLVideoElement)){requestAnimationFrame(vn);return}bn()};bt.initVideo(dt.video),i.current=dt.video,vn();let mo=window.setTimeout(()=>{if(Ze||s.current!==Ue||$t)return;$t=!0,o.current.active=!1,nt(),l.current=!0,To(Et.src),To(at.src),Et.initVideo(dt.video),at.initVideo(dt.video),i.current=dt.video,n.current=0;let Ft=()=>{if(Ze||s.current!==Ue)return;let zn=Et.src,lt=at.src;if(!(zn instanceof HTMLVideoElement)||!(lt instanceof HTMLVideoElement)){l.current=!1;return}for(let Pn of[zn,lt])Pn.muted=!0,Pn.loop=!0,pe()?Pn.play().catch(()=>{}):Pn.pause();B.current(),Je(),O.current(),l.current=!1},on=()=>{if(Ze||s.current!==Ue)return;let zn=Et.src,lt=at.src;if(!(zn instanceof HTMLVideoElement)||!(lt instanceof HTMLVideoElement)){requestAnimationFrame(on);return}Ft()};on()},4e3);return()=>{Ze=!0,window.clearTimeout(mo),l.current=!1}}o.current.active=!1,nt(),l.current=!0,To(Et.src),To(at.src),Et.initVideo(dt.video),at.initVideo(dt.video),i.current=dt.video,n.current=0;let Ht=()=>{if(Ze||s.current!==Ue)return;let gt=Et.src,bt=at.src;if(!(gt instanceof HTMLVideoElement)||!(bt instanceof HTMLVideoElement)){l.current=!1;return}for(let Pt of[gt,bt])if(Pt.muted=!0,Pt.loop=!0,pe())Pt.play().catch(()=>{});else{try{Pt.currentTime=0}catch{}Pt.pause()}pu(),B.current(),o.current.active=!1,n.current=0,Je(),l.current=!1,O.current()},et=()=>{if(Ze||s.current!==Ue)return;let gt=Et.src,bt=at.src;if(!(gt instanceof HTMLVideoElement)||!(bt instanceof HTMLVideoElement)){requestAnimationFrame(et);return}if(gt.readyState>=2&&bt.readyState>=2){Ht();return}let Pt=0,vt=()=>{Pt-=1,Pt<=0&&Ht()};gt.readyState<2&&(Pt+=1,gt.addEventListener("loadeddata",vt,{once:!0}),gt.addEventListener("canplay",vt,{once:!0})),bt.readyState<2&&(Pt+=1,bt.addEventListener("loadeddata",vt,{once:!0}),bt.addEventListener("canplay",vt,{once:!0})),Pt<=0&&Ht()},Dt=window.setTimeout(()=>{Ze||s.current!==Ue||Ht()},2e3);return et(),()=>{Ze=!0,window.clearTimeout(Dt),l.current=!1}};return{loadPrimaryVideos:Fe,flushPendingVideoLoad:ge}}u();function xf(e,t,n,o){let r=o??t,i=Nn(n,"base");jn(i)&&e.push({key:t,fxKey:t,config:n});let s=n.paramSync;if(!s)return;let l=r==="playbackCue"?lu(n.params):void 0;for(let m of Object.keys(s)){if(l!=null){let y=Number.parseInt(m.replace(/^frame/,""),10);if(m.startsWith("frame")&&Number.isFinite(y)&&y>l)continue}let d=Nn(n,m);jn(d)&&e.push({key:`${t}:${m}`,fxKey:t,paramKey:m,config:n})}}function AR(e,t,n){for(let[o,r]of Object.entries(n))if(r?.enabled){for(let i of r.layerIds){let s=t[i];s?.config.enabled&&xf(e,Pa(o,i),s.config,s.templateKey)}r.composite?.enabled&&xf(e,`group:${o}`,r.composite)}}function uS(e,t){if(!e||typeof e!="object")return[];let n=[];for(let o of Object.keys(e)){let r=e[o],i=Ds(o,r)??r;!i||!i.enabled||xf(n,o,i)}return t?.layerInstances&&t?.fxGroups&&AR(n,t.layerInstances,t.fxGroups),n}u();function vf(e){return e.readyState>=HTMLMediaElement.HAVE_CURRENT_DATA&&e.videoWidth>0&&e.videoHeight>0}function pS(){let e=window;if(e.__hydraInitVideoPatched)return;let t=e.s0;if(!t)return;let n=Object.getPrototypeOf(t);if(!n||typeof n.initVideo!="function")return;e.__hydraInitVideoPatched=!0;let o=n.tick;typeof o=="function"&&(n.tick=function(i){let s=this.src;if(!(this.dynamic&&s instanceof HTMLVideoElement&&!vf(s)))return o.call(this,i)}),n.initVideo=function(i="",s){let l=this;l.dynamic=!1;let m=l.src;if(l.src=null,m instanceof HTMLVideoElement)try{m.pause(),m.removeAttribute("src"),m.load()}catch{}if(!i){l.tex=l.regl.texture({shape:[1,1]});return}let d=l._hydraVideoLoadSeq=(l._hydraVideoLoadSeq??0)+1,y=document.createElement("video");y.crossOrigin="anonymous",y.autoplay=!1,y.loop=!0,y.muted=!0,y.playsInline=!0,y.preload="auto";let D=()=>{if(l._hydraVideoLoadSeq===d){if(!vf(y)){requestAnimationFrame(D);return}l.src=y,yb(y),l.tex=l.regl.texture({data:y,...s}),l.dynamic=!0;try{l.tex.subimage?.(y)}catch{}}},B=()=>{if(l._hydraVideoLoadSeq===d){try{y.currentTime=0}catch{}y.pause(),D()}},O=()=>{if(l._hydraVideoLoadSeq===d){if(xb()){y.play().then(D).catch(D);return}if(vf(y)){B();return}requestAnimationFrame(B)}};y.addEventListener("loadeddata",O,{once:!0});let K=tg(i),X=K.length>0?K:[Cs(i)],pe=Re=>{if(l._hydraVideoLoadSeq===d){if(Re>=X.length){l.dynamic=!1;return}y.src=X[Re],y.addEventListener("error",()=>{l._hydraVideoLoadSeq===d&&pe(Re+1)},{once:!0})}};pe(0)}}u();function ER(e,t){if(this.width===e&&this.height===t&&this.canvas.width===e&&this.canvas.height===t){z_()?nm(this,e,t):Fo()&&Jl();return}nm(this,e,t)}function mS(e){let t=window;if(t.__hydraSynthDebugPatched)return;let n=Object.getPrototypeOf(e);!n||typeof n.setResolution!="function"||(t.__hydraSynthDebugPatched=!0,n.setResolution=ER)}u();function PR(){if(typeof window>"u")return{width:1920,height:1080};let e=window.visualViewport,t=e?.width&&e.width>0?e.width:window.innerWidth,n=e?.height&&e.height>0?e.height:window.innerHeight;return{width:Math.max(1,Math.round(t)),height:Math.max(1,Math.round(n))}}function dS(e,t){let n=Math.min(typeof window<"u"&&window.devicePixelRatio||1,t),o=e?.clientWidth??0,r=e?.clientHeight??0,{width:i,height:s}=o>0&&r>0?{width:o,height:r}:PR();return{width:Math.max(2,Math.round(i*n)),height:Math.max(2,Math.round(s*n)),dpr:n}}u();function FR(e,t,n){let o=new Set;for(let r of n){if(!r.isActive())continue;let i=e.o[r.outputIndex];if(!i)continue;o.add(r.outputIndex);let s=r.maxSteps??4,l=Math.max(1,Math.min(s,Math.round(r.simSteps())));for(let m=0;m<l;m++)i.tick(t);r.afterSimFrame?.()}for(let r=0;r<e.o.length;r++)o.has(r)||e.o[r].tick(t)}function fS(e,t){return function(o){try{let r=e.synth.speed;if(e.sandbox.tick(),r===0&&(e.synth.speed=0),e.detectAudio===!0&&e.synth.a?.tick(),e.sandbox.set("time",e.synth.time+=o*.001*e.synth.speed),e.timeSinceLastUpdate+=o,!e.synth.fps||e.timeSinceLastUpdate>=1e3/e.synth.fps){if(e.synth.stats.fps=Math.ceil(1e3/e.timeSinceLastUpdate),e.synth.update)try{e.synth.update(e.timeSinceLastUpdate)}catch{}for(let s=0;s<e.s.length;s++)e.s[s].tick(e.synth.time);let i={time:e.synth.time,mouse:e.synth.mouse,bpm:e.synth.bpm,resolution:[e.canvas.width,e.canvas.height]};if(FR(e,i,t),e.isRenderingAll?e.renderAll({tex0:e.o[0].getCurrent?.()??e.o[0],tex1:e.o[1].getCurrent?.()??e.o[1],tex2:e.o[2].getCurrent?.()??e.o[2],tex3:e.o[3].getCurrent?.()??e.o[3],resolution:[e.canvas.width,e.canvas.height]}):e.renderFbo({tex0:e.output.getCurrent(),resolution:[e.canvas.width,e.canvas.height]}),e.synth.afterUpdate)try{e.synth.afterUpdate(e.timeSinceLastUpdate)}catch{}e.timeSinceLastUpdate=0}e.saveFrame===!0&&(e.canvasToImage(),e.saveFrame=!1)}catch(r){console.warn("Error during tick():",r)}}}u();u();var _S="hydra-midi-debug-in-v1";function OR(e){try{let t=sessionStorage.getItem(e);if(!t)return[];let n=JSON.parse(t);return Array.isArray(n)?n.filter(o=>typeof o=="string").slice(-120):[]}catch{return[]}}function HR(e,t){try{sessionStorage.setItem(e,JSON.stringify(t))}catch{}}var gS=OR(_S),Sf=0;function hS(){Sf!==0&&typeof window<"u"&&(window.clearTimeout(Sf),Sf=0),HR(_S,gS)}typeof window<"u"&&(window.addEventListener("pagehide",hS),window.addEventListener("visibilitychange",()=>{document.visibilityState==="hidden"&&hS()}));function IR(){return gS.slice()}typeof window<"u"&&(window.__HYDRA_MIDI_DEBUG__={in:IR});function BR(e){if(!e||typeof e!="object")return!1;for(let t of Object.keys(e)){let n=e[t];if(!n||typeof n!="object"||!n.enabled)continue;let o=n;if(o.isTrigger&&o.syncBand&&o.syncBand!=="none")return!0;let r=o.paramSync;if(r&&typeof r=="object"){for(let i of Object.values(r))if(i?.isTrigger&&i.band&&i.band!=="none")return!0}}return!1}function bS(e,t,n){if(BR(e))return!0;if(!t||!n)return!1;for(let o of Object.values(n))if(o?.enabled){if(o.composite?.enabled){let r=o.composite;if(r.isTrigger&&r.syncBand&&r.syncBand!=="none")return!0;let i=r.paramSync;if(i){for(let s of Object.values(i))if(s?.isTrigger&&s.band&&s.band!=="none")return!0}}for(let r of o.layerIds){let i=t[r];if(!i?.config.enabled)continue;let s=i.config;if(s.isTrigger&&s.syncBand&&s.syncBand!=="none")return!0;let l=s.paramSync;if(l){for(let m of Object.values(l))if(m?.isTrigger&&m.band&&m.band!=="none")return!0}}}return!1}u();function yS(){return{kick:0,snare:0,hat:0,bass:0,vocals:0,low:0,mid:0,high:0,beat:0,rhythm:0,specFast:0,specSlow:0,master:0}}var ot=e=>({current:e});function xS(e,t){let n=uo(t,[3,3,6]),[o,r,i]=uo(e,n);return[o/255,r/255,i/255]}function SS(e){let{canvas:t}=e,n=e.dprCap??2,o=e.clips.length>0?e.clips:[e.config.video].filter(Boolean),r=ie();r.customBands=yS();let i={...e.config,video:o[e.clipIndex??0]??e.config.video};db(i.fx);let s=ot(i);r.hydraSettings=i;let l=ot(t),m=ot(null),d=ot(!1),y=ot(void 0),D=ot(void 0),B=ot("full"),O=ot(120),K=ot(0),X=ot({active:!1,startTime:0,duration:0,resolvedType:0}),pe=ot(!1),Re=ot(0),ge=ot(0),Fe=ot(0),Qe=ot(()=>{}),Ze=ot(()=>{}),dt=ot(()=>{}),Et=ot(()=>{}),at=ot(""),nt=ot(()=>{}),ft=ot(null),A=ot(null),M=ot(()=>{}),k=ot(1),p=ot(!1),re=ot(null),we=ot(null),Ye=ot(0),Ue=ot(!1),Ne=ot(void 0),qe=ot(Rc()),Je=ot({count:0,slots:[]}),Ht=ot(null),et=ot(!1),Dt=ot(null),gt=ot(!1),bt=ot(Kv()),Pt=ot(!1),vt=ot(null),zt=ot(!1),tn=ot(nu()),$t=ot(!1),bn=ot(null),vn=ot(!1),mo=ot(!1),Ft=ot(null),on=ot(!1),zn=ot(!1),lt=ot(null),Pn=ot(!1),Mt=ot(!1),h=ot(null),Fn=ot(!1),Zn=ot(Cb()),Sn=ot(!1),On=ot({v0:null,v1:null}),Hn=ot(null),Qt=ot({active:!1,pendingTrigger:!1,phase:"forward",segmentStart0:0,segmentStart1:0,segmentEnd0:0,captureAccum:0,capturePending:!1,reverseIdx:-1,completeAfterReverse:!1,frames:{frames0:[],frames1:[]},lastFrameTime:0}),rn=ot(60),wn=ot(180),an=ot(null),Tn=ot(void 0),Mn=ot(null),xn=ot(void 0),Jn=ot(void 0),Go=ot(void 0),no=ot(bS(i.fx,i.layerInstances,i.fxGroups)),er=ot(uS(i.fx,{layerInstances:i.layerInstances,fxGroups:i.fxGroups})),oo=()=>ie().customBands,Vr=()=>ie().hydraSettings?.fx??s.current.fx,Rr=(_t,Ct,Xt)=>Zt(_t,Vr()?.[_t],Ct,Xt,oo()),Ar=_t=>bb(s.current.fx,oo(),(Ct,Xt,Ut)=>So(Ct,Xt,Ut),Rr,_t),bo=()=>dS(t,n),$r=()=>t.width>0&&t.height>0?{width:t.width,height:t.height}:bo(),tr=()=>s.current.isVideoPlaying!==!1,{width:un,height:zo}=bo();t.width=un,t.height=zo;let nr=HTMLCanvasElement.prototype,pr=nr.getContext;nr.getContext=function(Ct,Xt){return this===t&&(Ct==="webgl"||Ct==="webgl2"||Ct==="experimental-webgl")?pr.call(this,Ct,{...Xt,preserveDrawingBuffer:!0}):pr.apply(this,arguments)};let Yn;try{Yn=new S_({canvas:t,detectAudio:!1,makeGlobal:!0,autoLoop:!1,width:un,height:zo,numSources:wb()})}finally{nr.getContext=pr}m.current=Yn;let Uo=fS(Yn,[{outputIndex:1,isActive:()=>!!s.current.fx?.reactionDiffusion?.enabled,simSteps:()=>{let _t=Number(s.current.fx?.reactionDiffusion?.params?.speed??.45);return 1+Math.round(_t*2)}},{outputIndex:3,isActive:()=>Nb(s.current.fx),simSteps:()=>{let _t=Zt("patternLayer",s.current.fx?.patternLayer,"speed",.4,oo());return 3+Math.round(Math.max(0,Math.min(2,_t))*3)},maxSteps:6}]);Yn.tick=(_t,Ct)=>{if(!Fo()){Ql();try{Uo(_t,Ct)}finally{Re.current>0&&(Re.current-=1),Fe.current>0&&(Fe.current-=1),ge.current>0&&(ge.current-=1),Zl()}}},Qe.current=_t=>{if(Fo())return;M.current(),mb(Math.max(0,_t)/1e3);let Ct=ie().hydraSettings?.fx?.timeGlitch??s.current.fx?.timeGlitch,Xt=ie();v1({sources:[Xt.s0?.src,Xt.s1?.src],activeChannel:K.current,enabled:!!Ct?.enabled,warm:(s.current.activeFxList||[]).includes("timeGlitch"),amount:_n("timeGlitch",Ct,oo(),Xn),cols:Zt("timeGlitch",Ct,"cols",16,oo()),frameOffset:Zt("timeGlitch",Ct,"frameOffset",2,oo()),origin:Zt("timeGlitch",Ct,"origin",1,oo()),direction:Zt("timeGlitch",Ct,"direction",0,oo()),mode:Zt("timeGlitch",Ct,"mode",0,oo()),destWidth:t.width,destHeight:t.height}),Yn.tick?.(_t)};let F=(0,vS.default)(_t=>Qe.current(_t));if(F.start(),em({pause:()=>{F.stop(),ft.current?.()},resume:()=>{F.start(),A.current?.()}}),tm(()=>{pe.current=!1,dt.current()}),mS(Yn),pS(),Ux(Yn.synth),e2({settingsRef:s,backingWidth:un,backingHeight:zo,oscilloscopeBundleRef:Ht,neonGridBundleRef:Dt,textLayerBundleRef:vt,throughTheStarsBundleRef:bn,lumaDustBundleRef:Ft,lumaLockBundleRef:lt,metalEnvBundleRef:h,s3OverlayBindRef:Zn,textLayerRuntimeRef:tn,oscilloscopeBridgeReadyRef:et,neonGridBridgeReadyRef:gt,textLayerBridgeReadyRef:zt,throughTheStarsBridgeReadyRef:vn,lumaDustBridgeReadyRef:on,lumaLockBridgeReadyRef:Pn,metalEnvBridgeReadyRef:Fn,neonGridWasEnabledRef:Pt,textLayerWasEnabledRef:$t,throughTheStarsWasEnabledRef:mo,lumaDustWasEnabledRef:zn,lumaLockWasEnabledRef:Mt}),ki(i.fx?.patternLayer)){let _t=i.fx.patternLayer.params;Yn.synth?.setFunction?.({name:"patternTuringDisplay",type:"src",inputs:[...la],glsl:Ha(xS(_t?.colorA,"#030306"),xS(_t?.colorB,"#f0abfc"))})}Yn.setResolution?.(un,zo);let Bo=ie().s0?.regl;Bo&&(ny(Bo),D_(Bo),g1(Bo),Qb(Bo).then(()=>{requestAnimationFrame(()=>dt.current())})),Ze.current=()=>L1({applySceneDeferredRef:pe,hydraRef:m,settingsRef:s,studioModeRef:d,exportSettingsRef:y,outputMappingRef:D,transitionStateRef:X,activeChannelRef:K,reactionDiffForceSeedRef:Re,feedbackForceClearRef:ge,patternRdForceSeedRef:Fe,canvasRef:l,renderQualityRef:B,runHydraTickRef:Qe,electricNoiseCirclePackRef:Je,oscilloscopeBridgeReadyRef:et,neonGridBridgeReadyRef:gt,textLayerBridgeReadyRef:zt,throughTheStarsBridgeReadyRef:vn,lumaDustBridgeReadyRef:on,lumaLockBridgeReadyRef:Pn,getFxState:Vr,getParamValue:Rr}),dt.current=()=>{if(Fo()){pe.current=!0;return}ie().hydraSettings=s.current,Ze.current(),Fo()||Qe.current(16.67)},Et.current=_t=>{let Ct=ie(),Xt=Ct.s0?.src,Ut=Ct.s1?.src;if(!(Xt instanceof HTMLVideoElement)||!(Ut instanceof HTMLVideoElement))return;let mn=_t??Ar(Xt.duration);k.current=mn,Vm([Xt,Ut],mn)};let{loadPrimaryVideos:Ie,flushPendingVideoLoad:it}=cS({settingsRef:s,activeChannelRef:K,transitionStateRef:X,pendingVideoLoadRef:re,currentVideoRef:we,videoLoadSeqRef:Ye,clipLoadFreezeRef:Ue,secondaryVideoRef:Ne,boomerangBridgeReadyRef:Sn,boomerangBackingRef:On,boomerangStateRef:Qt,syncPlaybackRef:Et,applySceneAndRenderRef:dt,bumpLumaDustReset:()=>{Ft.current&&el(Ft.current),queueMicrotask(()=>Ze.current())},teardownBoomerangBridge:()=>{},isPrimaryPlaybackActive:tr}),We=lS({settingsRef:s,studioModeRef:d,bpmRef:O,hydraRef:m,hydraRenderBudgetKeyRef:at,syncHydraRenderBudgetRef:nt,runHydraTickRef:Qe,hydraResizePauseRef:ft,hydraResizeResumeRef:A,syncElectricNoiseTriggerTexRef:M,transitionStateRef:X,pendingVideoLoadRef:re,activeChannelRef:K,clipLoadFreezeRef:Ue,clipPeekDepsRef:Jn,onPlaybackCueRef:Go,boomerangBridgeReadyRef:Sn,boomerangBackingRef:On,boomerangCanvasBundleRef:Hn,boomerangStateRef:Qt,boomerangCaptureFpsCapRef:rn,boomerangMaxFramesCapRef:wn,currentSpeedSmoothedRef:k,fxReactiveTriggerGateRef:no,reactiveTriggerDescriptorsRef:er,electricNoiseCirclesRef:qe,electricNoiseCirclePackRef:Je,neonGridBundleRef:Dt,neonGridBridgeReadyRef:gt,neonGridRuntimeRef:bt,s3OverlayBindRef:Zn,throughTheStarsBundleRef:bn,throughTheStarsBridgeReadyRef:vn,lumaDustBundleRef:Ft,lumaDustBridgeReadyRef:on,lumaLockBundleRef:lt,lumaLockBridgeReadyRef:Pn,textLayerBundleRef:vt,textLayerBridgeReadyRef:zt,textLayerRuntimeRef:tn,oscilloscopeBundleRef:Ht,oscilloscopeBridgeReadyRef:et,metalEnvBundleRef:h,metalEnvBridgeReadyRef:Fn,perfLastPrimaryRef:an,perfVideoSinkRef:Tn,perfPresentationLastRef:Mn,perfPresentationSinkRef:xn,wasStudioFrozenRef:p,flushPendingVideoLoad:it,getParamValue:Rr,resolvePrimaryVideoSpeed:Ar,resolveStarLayerPixels:$r,isTransportFrozen:()=>s.current.isVideoPlaying===!1,isStudioTransportRunning:()=>!1,isVisualTransportPlaying:tr,bootstrapTransportFreeze:()=>{at.current="",nt.current(!1),Qe.current(16.67)},reportPresentationMode:()=>{}});Re.current=2,Fe.current=4;let ke=o.map(_t=>({path:_t})),St=()=>{let _t=ol(s.current.fx),Ct=R2(ke,s.current.video,_t?.config??null,_t?.key??null);if(!Ct||Ct===Ne.current)return;Ne.current=Ct;let Xt=ie().s2;Xt?.initVideo&&(Xt.src instanceof HTMLVideoElement&&Xt.src.pause(),Xt.initVideo(Ct),window.setTimeout(()=>{let Ut=ie().s2?.src;Ut instanceof HTMLVideoElement&&(Ut.muted=!0,Ut.loop=!0,tr()&&Ut.play().catch(()=>{}))},500))},en=Ie(!0);St(),dt.current();let pt=()=>{if(!tr())return;let _t=ie();ur(_t.s0?.src),ur(_t.s1?.src),Ue.current=!1},At=[window.setTimeout(pt,250),window.setTimeout(pt,750)],wt=o.indexOf(i.video)>=0?o.indexOf(i.video):0,pn=_t=>{if(o.length===0)return;let Ct=(_t%o.length+o.length)%o.length;Ct===wt&&s.current.video===o[Ct]||(wt=Ct,s.current={...s.current,video:o[Ct]},ie().hydraSettings=s.current,en(),en=Ie(!1),St())},eo=()=>{let _t=bo();t.width===_t.width&&t.height===_t.height||Yn.setResolution?.(_t.width,_t.height)},fo=()=>eo();window.addEventListener("resize",fo),document.addEventListener("fullscreenchange",fo);let yo=new ResizeObserver(fo);return yo.observe(t),{clipCount:o.length,clipIndex:()=>wt,selectClip:pn,nextClip:()=>pn(wt+1),previousClip:()=>pn(wt-1),isPlaying:()=>s.current.isVideoPlaying!==!1,setPlaying:_t=>{if(s.current={...s.current,isVideoPlaying:_t},ie().hydraSettings=s.current,_t)pt();else{let Ct=ie();Ct.s0?.src instanceof HTMLVideoElement&&Ct.s0.src.pause(),Ct.s1?.src instanceof HTMLVideoElement&&Ct.s1.src.pause()}dt.current()},resize:eo,dispose:()=>{hu(),At.forEach(_t=>window.clearTimeout(_t)),yo.disconnect(),window.removeEventListener("resize",fo),document.removeEventListener("fullscreenchange",fo),We(),em(null),tm(null),F.stop(),en(),m.current=null}}}function WR(e){let t=document.createElement("canvas");return t.id="hexa-canvas",t.style.cssText="position:absolute;inset:0;width:100%;height:100%;display:block",e.appendChild(t),t}function wj(e){let t=e.container??document.body,n=WR(t),o=Bh(e.scene),r=SS({canvas:n,config:o,clips:e.scene.clips,clipIndex:e.scene.clipIndex}),i=e.chrome===!1?null:Uh(t,{title:e.scene.title,clipCount:r.clipCount,onPrevious:()=>{r.previousClip(),i?.setClipIndex(r.clipIndex())},onNext:()=>{r.nextClip(),i?.setClipIndex(r.clipIndex())},onTogglePlay:()=>{let m=!r.isPlaying();return r.setPlaying(m),m},onToggleFullscreen:()=>{document.fullscreenElement?document.exitFullscreen():document.documentElement.requestFullscreen()}});i?.setClipIndex(r.clipIndex()),i?.setPlaying(r.isPlaying());let s=zh({autoMix:o.fx?.autoMix,clipCount:r.clipCount,currentIndex:()=>r.clipIndex(),selectClip:m=>{r.selectClip(m),i?.setClipIndex(r.clipIndex())}}),l=m=>{if(m.key===" "){m.preventDefault();let d=!r.isPlaying();r.setPlaying(d),i?.setPlaying(d)}else m.key==="ArrowRight"?(r.nextClip(),i?.setClipIndex(r.clipIndex())):m.key==="ArrowLeft"?(r.previousClip(),i?.setClipIndex(r.clipIndex())):m.key.toLowerCase()==="f"&&(document.fullscreenElement?document.exitFullscreen():document.documentElement.requestFullscreen())};return window.addEventListener("keydown",l),{host:r,destroy:()=>{window.removeEventListener("keydown",l),s.stop(),i?.destroy(),r.dispose(),n.remove()}}}export{wj as mountPlayer};
